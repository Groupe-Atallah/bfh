...
var BFHStatesList = {
  'AF':{
    ...
    '2' : {'code':'BAM','name':'Bâmiyân'},
    '3' : {'code':'BDG','name':'Bâdghis'},
    '4' : {'code':'BDS','name':'Badakhchan'},
    '5' : {'code':'BGL','name':'Baghlân'},
    '6' : {'code':'FRA','name':'Farâh'},
    '7' : {'code':'FYB','name':'Fâryâb'},
    '8' : {'code':'GHA','name':'Ghazni'},
    '9' : {'code':'GHO','name':'Ghôr'},
    '10' : {'code':'HEL','name':'Helmand'},
    '11' : {'code':'HER','name':'Hérât'},
    '12' : {'code':'JOW','name':'Djôzdjân'},
    '13' : {'code':'KAB','name':'Kaboul'},
    '14' : {'code':'KAN','name':'Kandahâr'},
    '15' : {'code':'KAP','name':'Kâpîssâ'},
    '16' : {'code':'KDZ','name':'Kondôz'},
    '17' : {'code':'KHO','name':'Khôst'},
    '18' : {'code':'KNR','name':'Kounar'},
    '19' : {'code':'LAG','name':'Laghmân'},
    '20' : {'code':'LOW','name':'Lôgar'},
    '21' : {'code':'NAN','name':'Nangarhâr'},
    '22' : {'code':'NIM','name':'Nimrôz'},
    '23' : {'code':'NUR','name':'Nourestân'},
    '24' : {'code':'ORU','name':'Orozgân'},
    '25' : {'code':'PAR','name':'Parwân'},
    '26' : {'code':'PIA','name':'Paktiyâ'},
    '27' : {'code':'PKA','name':'Paktîkâ'},
    '28' : {'code':'SAM','name':'Samangân'},
    '29' : {'code':'SAR','name':'Sar-é Pol'},
    '30' : {'code':'TAK','name':'Takhâr'},
    '31' : {'code':'WAR','name':'Wardak'},
    '32' : {'code':'ZAB','name':'Zabol'}
  },
  'AL':{
    '1' : {'code':'BR','name':'Berat'},
    '2' : {'code':'BU','name':'Bulkizë'},
    '3' : {'code':'DI','name':'Dibër'},
    '4' : {'code':'DL','name':'Delvinë'},
    '5' : {'code':'DR','name':'Durrës'},
    '6' : {'code':'DV','name':'Devoll'},
    '7' : {'code':'EL','name':'Elbasan'},
    '8' : {'code':'ER','name':'Kolonjë'},
    '9' : {'code':'FR','name':'Fier'},
    '10' : {'code':'GJ','name':'Gjirokastër'},
    '11' : {'code':'GR','name':'Gramsh'},
    '12' : {'code':'HA','name':'Has'},
    '13' : {'code':'KA','name':'Kavajë'},
    '14' : {'code':'KB','name':'Kurbin'},
    '15' : {'code':'KC','name':'Kuçovë'},
    '16' : {'code':'KO','name':'Korçë'},
    '17' : {'code':'KR','name':'Krujë'},
    '18' : {'code':'KU','name':'Kukës'},
    '19' : {'code':'LB','name':'Librazhd'},
    '20' : {'code':'LE','name':'Lezhë'},
    '21' : {'code':'LU','name':'Lushnjë'},
    '22' : {'code':'MK','name':'Mallakastër'},
    '23' : {'code':'MM','name':'Malësi e Madhe'},
    '24' : {'code':'MR','name':'Mirdite'},
    '25' : {'code':'MT','name':'Mat'},
    '26' : {'code':'PG','name':'Pogradec'},
    '27' : {'code':'PQ','name':'Peqin'},
    '28' : {'code':'PR','name':'Përmet'},
    '29' : {'code':'PU','name':'Pukë'},
    '30' : {'code':'SH','name':'Shkodër'},
    '31' : {'code':'SK','name':'Skrapar'},
    '32' : {'code':'SR','name':'Sarandë'},
    '33' : {'code':'TE','name':'Tepelenë'},
    '34' : {'code':'TP','name':'Tropojë'},
    '35' : {'code':'TR','name':'Tirana'},
    '36' : {'code':'VL','name':'Vlorë'}
  },
  'DZ':{
    '1' : {'code':'ADE','name':'Aïn Defla'},
    '2' : {'code':'ADR','name':'Adrar'},
    '3' : {'code':'ALG','name':'Alger'},
    '4' : {'code':'ANN','name':'Annaba'},
    '5' : {'code':'ATE','name':'Aïn Témouchent'},
    '6' : {'code':'BAT','name':'Batna'},
    '7' : {'code':'BBA','name':'Bordj Bou Arréridj'},
    '8' : {'code':'BEC','name':'Béchar'},
    '9' : {'code':'BEJ','name':'Béjaïa'},
    '10' : {'code':'BIS','name':'Biskra'},
    '11' : {'code':'BLI','name':'Blida'},
    '12' : {'code':'BMD','name':'Boumerdès'},
    ...
    '37' : {'code':'SAI','name':'Saïda'},
    '38' : {'code':'SBA','name':'Sidi Bel Abbès'},
    '39' : {'code':'SET','name':'Sétif'},
    '40' : {'code':'SKI','name':'Skikda'},
    '41' : {'code':'TAM','name':'Tamanrasset'},
    '42' : {'code':'TEB','name':'Tébessa'},
  ...
  'AD':{
    '1' : {'code':'ALV','name':'Andorre-la-Vieille'},
  ...
  'AR':{
    '1' : {'code':'AN','name':'Antarctique et Îles de l\'Atlantique'},
    ...
    '8' : {'code':'CF','name':'Buenos Aires District fédéral'},
    ...
    '24' : {'code':'TF','name':'Terre de Feu'},
    '25' : {'code':'TU','name':'Tucumán'}
  },
  'AM':{
    '1' : {'code':'AGT','name':'Aragatsotn'},
    '2' : {'code':'ARR','name':'Ararat'},
    '3' : {'code':'ARM','name':'Armavir'},
    '4' : {'code':'GEG','name':'Gegharkunik'},
  ...
  'AU':{
    '1' : {'code':'ACT','name':'Territoire de la capitale australienne'},
    '2' : {'code':'NSW','name':'Nouvelle-Galles du Sud'},
    '3' : {'code':'NT','name':'Territoire du Nord'},
    '4' : {'code':'QLD','name':'Queensland'},
    '5' : {'code':'SA','name':'Australie-Méridionale'},
    '6' : {'code':'TAS','name':'Tasmanie'},
    '7' : {'code':'VIC','name':'Victoria'},
    '8' : {'code':'WA','name':'Australie-Occidentale'}
  },
  'AT':{
    '1' : {'code':'BUR','name':'Burgenland'},
    '2' : {'code':'KAR','name':'Carinthie'},
    '3' : {'code':'NOS','name':'Basse-Autriche'},
    '4' : {'code':'OOS','name':'Haute-Autriche'},
    '5' : {'code':'SAL','name':'Salzbourg'},
    '6' : {'code':'STE','name':'Styrie'},
    '7' : {'code':'TIR','name':'Tyrol'},
    '8' : {'code':'VOR','name':'Vorarlberg'},
    '9' : {'code':'WIE','name':'Vienne'}
  },
  'AZ':{
    '1' : {'code':'AB','name':'Şirvan'},
    '2' : {'code':'ABS','name':'Abşeron'},
    '3' : {'code':'AGC','name':'Ağcabədi'},
    '4' : {'code':'AGM','name':'Agdam'},
    '5' : {'code':'AGS','name':'Ağdaş'},
    '6' : {'code':'AGA','name':'Ağstafa'},
    '7' : {'code':'AGU','name':'Ağsu'},
    '8' : {'code':'AST','name':'Astara'},
    '9' : {'code':'BA','name':'Bakou'},
    '10' : {'code':'BAB','name':'Babək'},
    '11' : {'code':'BAL','name':'Balakən'},
    '12' : {'code':'BAR','name':'Bərdə'},
    '13' : {'code':'BEY','name':'Beyləqan'},
    '14' : {'code':'BIL','name':'Biləsuvar'},
    '15' : {'code':'CAB','name':'Cəbrayıl'},
    '16' : {'code':'CAL','name':'Cəlilabad'},
    '17' : {'code':'CUL','name':'Culfa'},
    '18' : {'code':'DAS','name':'Daşkəsən'},
    '19' : {'code':'DAV','name':'Dəvəçi'},
    '20' : {'code':'FUZ','name':'Füzuli'},
    '21' : {'code':'GA','name':'Gandja'},
    '22' : {'code':'GAD','name':'Gədəbəy'},
    '23' : {'code':'GOR','name':'Goranboy'},
    '24' : {'code':'GOY','name':'Göyçay'},
    '25' : {'code':'HAC','name':'Hacıqabul'},
    '26' : {'code':'IMI','name':'İmişli'},
    '27' : {'code':'ISM','name':'Ismayilli'},
    '28' : {'code':'KAL','name':'Kəlbəcər'},
    '29' : {'code':'KUR','name':'Kürdəmir'},
    '30' : {'code':'LA','name':'Lankaran (Ville)'},
    '31' : {'code':'LAC','name':'Laçın'},
    '32' : {'code':'LAN','name':'Lankaran (Raion)'},
    '33' : {'code':'LER','name':'Lerik'},
    '34' : {'code':'MAS','name':'Masallı'},
    '35' : {'code':'MI','name':'Mingachevir'},
    '36' : {'code':'NA','name':'Naftalan'},
    '37' : {'code':'NX','name':'Nakhitchevan'},
    '38' : {'code':'NEF','name':'Neftçala'},
    '39' : {'code':'OGU','name':'Oğuz'},
    '40' : {'code':'ORD','name':'Ordubad'},
    '41' : {'code':'QAB','name':'Qəbələ'},
    '42' : {'code':'QAX','name':'Qax'},
    '43' : {'code':'QAZ','name':'Qazax'},
    '44' : {'code':'QOB','name':'Qobustan'},
    '45' : {'code':'QBA','name':'Quba'},
    '46' : {'code':'QBI','name':'Qubadlı'},
    '47' : {'code':'QUS','name':'Qusar'},
    '48' : {'code':'SA','name':'Saki (Ville)'},
    '49' : {'code':'SAT','name':'Saatlı'},
    '50' : {'code':'SAB','name':'Sabirabad'},
    '51' : {'code':'SAD','name':'Sadarak'},
    '52' : {'code':'SAH','name':'Sahbuz'},
    '53' : {'code':'SAK','name':'Şəki (Raion)'},
    '54' : {'code':'SAL','name':'Salyan'},
    '55' : {'code':'SM','name':'Sumqayıt'},
    '56' : {'code':'SMI','name':'Şamaxı'},
    '57' : {'code':'SKR','name':'Şəmkir'},
    '58' : {'code':'SMX','name':'Samux'},
    '59' : {'code':'SAR','name':'Şərur'},
    '60' : {'code':'SIY','name':'Siyəzən'},
    '61' : {'code':'SS','name':'Şuşa (Ville)'},
    '62' : {'code':'SUS','name':'Şuşa (Raion)'},
    '63' : {'code':'TAR','name':'Tərtər'},
    '64' : {'code':'TOV','name':'Tovuz'},
    '65' : {'code':'UCA','name':'Ucar'},
    '66' : {'code':'XA','name':'Xankəndi'},
    '67' : {'code':'XAC','name':'Xaçmaz'},
    '68' : {'code':'XAN','name':'Göygöl'},
    '69' : {'code':'XIZ','name':'Xızı'},
    '70' : {'code':'XCI','name':'Xocalı'},
    '71' : {'code':'XVD','name':'Xocavənd'},
    '72' : {'code':'YAR','name':'Yardımlı'},
    '73' : {'code':'YEV','name':'Ievlakh'},
    '74' : {'code':'ZAN','name':'Zəngilan'},
    '75' : {'code':'ZAQ','name':'Zaqatala'},
    '76' : {'code':'ZAR','name':'Zərdab'}
  },
  'BS':{
    '1' : {'code':'ACK','name':'Acklins'},
    '2' : {'code':'BER','name':'Îles Berry'},
    '3' : {'code':'BIM','name':'Îles Bimini'},
    '4' : {'code':'BLK','name':'Black Point'},
    '5' : {'code':'CAT','name':'île Cat'},
    '6' : {'code':'CAB','name':'Central Abaco'},
    '7' : {'code':'CAN','name':'Central Andros'},
    '8' : {'code':'CEL','name':'Central Eleuthera'},
    '9' : {'code':'FRE','name':'Freeport'},
    '10' : {'code':'CRO','name':'Crooked Island'},
    '11' : {'code':'EGB','name':'East Grand Bahama'},
    '12' : {'code':'EXU','name':'Îles Exuma'},
  ...
  'BY':{
    '1' : {'code':'BR','name':'Brest'},
    '2' : {'code':'HO','name':'Homiel'},
    '3' : {'code':'HM','name':'Horad Minsk'},
    '4' : {'code':'HR','name':'Hrodna'},
    '5' : {'code':'MA','name':'Moguilev'},
    '6' : {'code':'MI','name':'Minsk'},
    '7' : {'code':'VI','name':'Vitebsk'}
  },
  'BE':{
    '1' : {'code':'VAN','name':'Anvers'},
    '2' : {'code':'WBR','name':'Brabant wallon'},
    '3' : {'code':'WHT','name':'Hainaut'},
    '4' : {'code':'WLG','name':'Liège'},
    '5' : {'code':'VLI','name':'Limbourg'},
    '6' : {'code':'WLX','name':'Luxembourg'},
    '7' : {'code':'WNA','name':'Namur'},
    '8' : {'code':'VOV','name':'Flandre orientale'},
    '9' : {'code':'VBR','name':'Brabant flamand'},
    '10' : {'code':'VWV','name':'Flandre occidentale'}
  },
  'BZ':{
  ...
  'BO':{
    ...
    '7' : {'code':'POT','name':'Potosí'},
    '8' : {'code':'SCZ','name':'Santa Cruz'},
    '9' : {'code':'TAR','name':'Tarija'}
  },
  'BA':{
    '1' : {'code':'BRO','name':'District de Brčko'},
    '2' : {'code':'FBP','name':'Canton du Podrinje bosnien'},
    '3' : {'code':'FHN','name':'Canton de Neretva-Herzegovine'},
    '4' : {'code':'FPO','name':'Canton de Posavina'},
    '5' : {'code':'FSA','name':'Canton de Sarajevo'},
    '6' : {'code':'FSB','name':'Canton de Bosnie centrale'},
    '7' : {'code':'FTU','name':'Canton de Tuzla'},
    '8' : {'code':'FUS','name':'Canton d\'Una-Sana'},
    '9' : {'code':'FZA','name':'Canton de Bosnie de l\'ouest'},
    '10' : {'code':'FZE','name':'Canton de Zenica-Doboj'},
    '11' : {'code':'FZH','name':'Canton de l\'Herzégovine de l\'ouest '},
    '12' : {'code':'SBI','name':'Bijeljina'},
    '13' : {'code':'SBL','name':'Banja Luka'},
    '14' : {'code':'SDO','name':'Doboj'},
    '15' : {'code':'SFO','name':'Foča'},
    '16' : {'code':'SSR','name':'Sarajevo-Romanija et Sokolac'},
  ...
  'BW':{
    ...
    '7' : {'code':'NE','name':'Nord-Est'},
    '8' : {'code':'NW','name':'Nord-Ouest'},
  ...
  'BR':{
    ...
    '3' : {'code':'AP','name':'Amapá'},
    '4' : {'code':'AM','name':'Amazonas'},
    '5' : {'code':'BA','name':'Bahia'},
    '6' : {'code':'CE','name':'Ceará'},
    '7' : {'code':'DF','name':'District Fédéral'},
    '8' : {'code':'ES','name':'Espírito Santo'},
    '9' : {'code':'GO','name':'Goiás'},
    '10' : {'code':'MA','name':'Maranhão'},
    '11' : {'code':'MT','name':'Mato Grosso'},
    '12' : {'code':'MS','name':'Mato Grosso do Sul'},
    '13' : {'code':'MG','name':'Minas Gerais'},
    '14' : {'code':'PA','name':'Pará'},
    '15' : {'code':'PB','name':'Paraíba'},
    '16' : {'code':'PR','name':'Paraná'},
    '17' : {'code':'PE','name':'Pernambouc'},
    '18' : {'code':'PI','name':'Piauí'},
    '19' : {'code':'RJ','name':'Rio de Janeiro'},
    '20' : {'code':'RN','name':'Rio Grande do Norte'},
    '21' : {'code':'RS','name':'Rio Grande do Sul'},
    '22' : {'code':'RO','name':'Rondônia'},
    '23' : {'code':'RR','name':'Roraima'},
    '24' : {'code':'SC','name':'Santa Catarina'},
    '25' : {'code':'SP','name':'São Paulo'},
  ...
  'BF':{
    ...
    '15' : {'code':'KEN','name':'Kénédougou'},
    '16' : {'code':'KOD','name':'Komondjari'},
    '17' : {'code':'KOP','name':'Kompienga'},
    '18' : {'code':'KOS','name':'Kossi'},
    '19' : {'code':'KOL','name':'Koulpélogo'},
    '20' : {'code':'KOT','name':'Kouritenga'},
    '21' : {'code':'KOW','name':'Kourwéogo'},
    '22' : {'code':'LER','name':'Léraba'},
    ...
    '31' : {'code':'PAS','name':'Passoré'},
    '32' : {'code':'PON','name':'Poni'},
    '33' : {'code':'SAG','name':'Sanguié'},
    '34' : {'code':'SAM','name':'Sanmatenga'},
    '35' : {'code':'SEN','name':'Séno'},
  ...
  'KH':{
    ...
    '2' : {'code':'BM','name':'Banteay Mean Chey'},
    '3' : {'code':'KB','name':'Kep'},
    ...
    '12' : {'code':'KU','name':'Kampong Spoe'},
    '13' : {'code':'MK','name':'Mondol Kiri'},
    '14' : {'code':'OM','name':'Otdar Mean Cheay'},
    '15' : {'code':'PA','name':'Pailin'},
    '16' : {'code':'PG','name':'Prey Veng'},
    '17' : {'code':'PP','name':'Phnom Penh'},
    '18' : {'code':'PR','name':'Preah Vihear'},
    '19' : {'code':'PS','name':'Preah Sihanouk (Kompong Som ou Si)'},
    '20' : {'code':'PU','name':'Pouthisat'},
    '21' : {'code':'RK','name':'Rotanah Kiri'},
    '22' : {'code':'SI','name':'Siem Reap'},
    '23' : {'code':'SR','name':'Svay Rieng'},
    '24' : {'code':'ST','name':'Stoeng Treng'},
    '25' : {'code':'TK','name':'Takeo'}
  },
  'CM':{
    '1' : {'code':'ADA','name':'Adamaoua'},
    '2' : {'code':'CEN','name':'Centre'},
    '3' : {'code':'EST','name':'Est'},
    '4' : {'code':'EXN','name':'Extrême-Nord'},
    '5' : {'code':'LIT','name':'Littoral'},
    '6' : {'code':'NOR','name':'Nord'},
    '7' : {'code':'NOT','name':'Nord-Ouest'},
    '8' : {'code':'OUE','name':'Ouest'},
    '9' : {'code':'SUD','name':'Sud'},
    '10' : {'code':'SOU','name':'Sud-Ouest'}
  },
  'CA':{
    '1' : {'code':'AB','name':'Alberta'},
    '2' : {'code':'BC','name':'Colombie-Britannique'},
    '3' : {'code':'MB','name':'Manitoba'},
    '4' : {'code':'NB','name':'Nouveau-Brunswick'},
    '5' : {'code':'NL','name':'Terre-Neuve et Labrador'},
    '6' : {'code':'NT','name':'Territoires du Nord-Ouest'},
    '7' : {'code':'NS','name':'Nouvelle-Écosse'},
    '8' : {'code':'NU','name':'Nunavut'},
    '9' : {'code':'ON','name':'Ontario'},
    '10' : {'code':'PE','name':'Île-du-Prince-Édouard'},
    '11' : {'code':'QC','name':'Québec'},
    '12' : {'code':'SK','name':'Saskatchewan'},
    '13' : {'code':'YT','name':'Territoire du Yukon'}
  },
  'CV':{
    '1' : {'code':'BV','name':'Boa Vista'},
    '2' : {'code':'BR','name':'Brava'},
    '3' : {'code':'CS','name':'Calheta de São Miguel'},
    '4' : {'code':'MA','name':'Maio'},
    ...
    '13' : {'code':'SD','name':'São Domingos'},
    '14' : {'code':'SF','name':'São Filipe'},
    '15' : {'code':'SN','name':'São Nicolau'},
    '16' : {'code':'SV','name':'São Vicente'},
  ...
  'CF':{
    ...
    '6' : {'code':'KEM','name':'Kémo'},
    '7' : {'code':'LOB','name':'Lobaye'},
    '8' : {'code':'MBO','name':'Mbomou'},
    '9' : {'code':'MKD','name':'Mambéré-Kadéï'},
    '10' : {'code':'NGR','name':'Nana-Grébizi'},
    '11' : {'code':'NMM','name':'Nana-Mambéré'},
    '12' : {'code':'OMP','name':'Ombella-Mpoko'},
    '13' : {'code':'OPE','name':'Ouham-Pendé'},
    '14' : {'code':'OUH','name':'Ouham'},
    '15' : {'code':'OUK','name':'Ouaka'},
    '16' : {'code':'SMB','name':'Sangha-Mbaéré'},
  ...
  'TD':{
    ...
    '5' : {'code':'GU','name':'Guéra'},
    '6' : {'code':'KA','name':'Kanem'},
    '7' : {'code':'LA','name':'Lac'},
    '8' : {'code':'LC','name':'Logone-Occidental'},
    '9' : {'code':'LR','name':'Logone-Oriental'},
    '10' : {'code':'MK','name':'Mayo-Kébbi'},
    '11' : {'code':'MC','name':'Moyen-Chari'},
    '12' : {'code':'OU','name':'Ouaddaï'},
    '13' : {'code':'SA','name':'Salamat'},
    '14' : {'code':'TA','name':'Tandjilé'}
  },
  'CL':{
    '1' : {'code':'AI','name':'Aisén del General Carlos Ibanez'},
    '2' : {'code':'AN','name':'Antofagasta'},
    '3' : {'code':'AR','name':'Araucanie'},
    '4' : {'code':'AT','name':'Atacama'},
    '5' : {'code':'BI','name':'Biobío'},
    '6' : {'code':'CO','name':'Coquimbo'},
    '7' : {'code':'LI','name':'Libertador General Bernardo O\'Higgins'},
    '8' : {'code':'LL','name':'Los Lagos'},
    '9' : {'code':'MA','name':'Magallanes et Antartique Chilienne'},
    '10' : {'code':'ML','name':'Maule'},
    '11' : {'code':'RM','name':'Región Metropolitana'},
    '12' : {'code':'TA','name':'Tarapaca'},
    '13' : {'code':'VS','name':'Valparaíso'}
  },
  'CN':{
    '1' : {'code':'AN','name':'Anhui'},
    '2' : {'code':'BE','name':'Pékin'},
  ...
  'CI':{
    ...
    '40' : {'code':'ODI','name':'Odienné'},
    '41' : {'code':'OUM','name':'Oumé'},
    '42' : {'code':'SAK','name':'Sakassou'},
    '43' : {'code':'SPE','name':'San-Pédro'},
    '44' : {'code':'SAS','name':'Sassandra'},
    '45' : {'code':'SEG','name':'Séguéla'},
    '46' : {'code':'SIN','name':'Sinfra'},
    '47' : {'code':'SOU','name':'Soubré'},
    '48' : {'code':'TAB','name':'Tabou'},
    '49' : {'code':'TAN','name':'Tanda'},
    '50' : {'code':'TIE','name':'Tiébissou'},
    '51' : {'code':'TIN','name':'Tingréla'},
    '52' : {'code':'TIA','name':'Tiassalé'},
    ...
    '58' : {'code':'ZUE','name':'Zuénoula'}
  },
  'HR':{
    '1' : {'code':'BB','name':'Bjelovar-Bilogora'},
    '2' : {'code':'CZ','name':'Ville de Zagreb'},
    '3' : {'code':'DN','name':'Dubrovnik-Neretva'},
    '4' : {'code':'IS','name':'Istrie'},
    '5' : {'code':'KA','name':'Karlovac'},
    '6' : {'code':'KK','name':'Koprivnica-Križevci'},
    '7' : {'code':'KZ','name':'Krapina-Zagorje'},
    '8' : {'code':'LS','name':'Lika-Senj'},
    '9' : {'code':'ME','name':'Međimurje'},
    '10' : {'code':'OB','name':'Osijek-Baranja'},
    '11' : {'code':'PS','name':'Požega-Slavonie'},
    '12' : {'code':'PG','name':'Primorje-Gorski Kotar'},
    '13' : {'code':'SI','name':'Šibenik'},
    '14' : {'code':'SM','name':'Sisak-Moslavina'},
    '15' : {'code':'SB','name':'Slavonski Brod-Posavina'},
    '16' : {'code':'SD','name':'Split-Dalmatie'},
    '17' : {'code':'VA','name':'Varaždin'},
    '18' : {'code':'VP','name':'Virovitica-Podravina'},
    '19' : {'code':'VS','name':'Vukovar-Syrmie'},
    '20' : {'code':'ZK','name':'Zadar-Knin'},
    '21' : {'code':'ZA','name':'Zagreb'}
  },
  'CU':{
    '1' : {'code':'CA','name':'Camagüey'},
    '2' : {'code':'CD','name':'Ciego de Ávila'},
    '3' : {'code':'CI','name':'Cienfuegos'},
    '4' : {'code':'CH','name':'Ciudad de La Habana'},
    '5' : {'code':'GR','name':'Granma'},
    '6' : {'code':'GU','name':'Guantánamo'},
    '7' : {'code':'HO','name':'Holguín'},
    '8' : {'code':'IJ','name':'Isla de la Juventud'},
    '9' : {'code':'LH','name':'La Havane'},
    '10' : {'code':'LT','name':'Las Tunas'},
    '11' : {'code':'MA','name':'Matanzas'},
    '12' : {'code':'PR','name':'Pinar del Río'},
    '13' : {'code':'SS','name':'Sancti Spíritus'},
    '14' : {'code':'SC','name':'Santiago de Cuba'},
    '15' : {'code':'VC','name':'Villa Clara'}
  },
  'CY':{
    '1' : {'code':'F','name':'Famagouste'},
    '2' : {'code':'K','name':'Kyrenia'},
    '3' : {'code':'A','name':'Larnaca'},
    '4' : {'code':'I','name':'Limassol'},
    '5' : {'code':'N','name':'Nicosie'},
    '6' : {'code':'P','name':'Paphos'}
  },
  'CZ':{
    '1' : {'code':'A','name':'Prague'},
    '2' : {'code':'B','name':'Moravie du Sud'},
    '3' : {'code':'C','name':'Bohême-du-Sud'},
    '4' : {'code':'E','name':'Pardubice'},
    '5' : {'code':'H','name':'Hradec Králové'},
    '6' : {'code':'J','name':'Vysočina'},
    '7' : {'code':'K','name':'Karlovy Vary'},
    '8' : {'code':'L','name':'Liberec'},
    '9' : {'code':'M','name':'Olomouc'},
    '10' : {'code':'P','name':'Pilsen'},
    '11' : {'code':'S','name':'Bohême centrale'},
    '12' : {'code':'T','name':'Moravie-Silésie'},
    '13' : {'code':'U','name':'Ústi nad Labem'},
    '14' : {'code':'Z','name':'Zlín'}
  },
  'DK':{
    '1' : {'code':'AR','name':'Århus'},
    '2' : {'code':'BH','name':'Bornholm'},
    '3' : {'code':'CO','name':'Copenhague'},
    '4' : {'code':'FO','name':'Îles Féroé'},
    '5' : {'code':'FR','name':'Frederiksberg'},
    '6' : {'code':'FY','name':'Fionie'},
    '7' : {'code':'KO','name':'København'},
    '8' : {'code':'NO','name':'Jutland du Nord'},
    '9' : {'code':'RI','name':'Ribe'},
    '10' : {'code':'RK','name':'Ringkøbing'},
    '11' : {'code':'RO','name':'Roskilde'},
    '12' : {'code':'SO','name':'Jutland-du-Sud'},
    '13' : {'code':'ST','name':'Storstrøm'},
    '14' : {'code':'VK','name':'Vejle'},
    '15' : {'code':'VJ','name':'Sjælland-Occidental'},
    '16' : {'code':'VB','name':'Viborg'}
  },
  'DJ':{
    '1' : {'code':'S','name':'Ali Sabieh'},
    '2' : {'code':'K','name':'Dikhil'},
    '3' : {'code':'J','name':'Djibouti'},
    '4' : {'code':'O','name':'Obock'},
    '5' : {'code':'T','name':'Tadjourah'}
  },
  'DM':{
    '1' : {'code':'AND','name':'Saint-Andrew'},
    '2' : {'code':'DAV','name':'Saint-David'},
    '3' : {'code':'GEO','name':'Saint-George'},
    '4' : {'code':'JOH','name':'Saint-John'},
    '5' : {'code':'JOS','name':'Saint-Joseph'},
    '6' : {'code':'LUK','name':'Saint-Luke'},
    '7' : {'code':'MAR','name':'Saint-Mark'},
    '8' : {'code':'PAT','name':'Saint-Patrick'},
    '9' : {'code':'PAU','name':'Saint-Paul'},
    '10' : {'code':'PET','name':'Saint-Peter'}
  },
  'DO':{
    ...
    '5' : {'code':'DJ','name':'Dajabón'},
    '6' : {'code':'DU','name':'Duarte'},
    '7' : {'code':'EL','name':'Elas Piña'},
    '8' : {'code':'SY','name':'El Seibo'},
  ...
  'EG':{
    '1' : {'code':'DHY','name':'Dakahleya'},
    '2' : {'code':'BAM','name':'Mer-Rouge'},
    '3' : {'code':'BHY','name':'Beheira'},
    '4' : {'code':'FYM','name':'Fayoum'},
    '5' : {'code':'GBY','name':'Gharbeya'},
    '6' : {'code':'IDR','name':'Alexandrie'},
    '7' : {'code':'IML','name':'Ismaïlia'},
    '8' : {'code':'JZH','name':'Gizeh'},
    '9' : {'code':'MFY','name':'Menufeya'},
    '10' : {'code':'MNY','name':'Minya'},
    '11' : {'code':'QHR','name':'Le Caire'},
    '12' : {'code':'QLY','name':'Qalyuubiya'},
    '13' : {'code':'WJD','name':'Nouvelle-Vallée'},
    '14' : {'code':'SHQ','name':'Ach-Charqiya'},
    '15' : {'code':'SWY','name':'Suez'},
    '16' : {'code':'ASW','name':'Assouan'},
    '17' : {'code':'ASY','name':'Assiout'},
    '18' : {'code':'BSW','name':'Beni Souef'},
    '19' : {'code':'BSD','name':'Port-Saïd'},
    '20' : {'code':'DMY','name':'Damiette'},
    '21' : {'code':'JNS','name':'JSinaï Sud'},
    '22' : {'code':'KSH','name':'Kafr el-Cheik'},
    '23' : {'code':'MAT','name':'Marsa-Matruh'},
    '24' : {'code':'QIN','name':'Qena'},
    '25' : {'code':'SHS','name':'Sinaï Nord'},
    '26' : {'code':'SUH','name':'Sohag'}
  },
  'SV':{
    '1' : {'code':'AH','name':'Ahuachapán'},
    '2' : {'code':'CA','name':'Cabañas'},
    '3' : {'code':'CH','name':'Chalatenango'},
    '4' : {'code':'CU','name':'Cuscatlán'},
    '5' : {'code':'LB','name':'La Libertad'},
    '6' : {'code':'PZ','name':'La Paz'},
    '7' : {'code':'UN','name':'La Unión'},
    '8' : {'code':'MO','name':'Morazán'},
    ...
    '14' : {'code':'US','name':'Usulután'}
  },
  'GQ':{
    '1' : {'code':'AN','name':'Annobón'},
    '2' : {'code':'BN','name':'Bioko Norte'},
    '3' : {'code':'BS','name':'Bioko Sur'},
    '4' : {'code':'CS','name':'Centro Sur'},
    '5' : {'code':'KN','name':'Kié-Ntem'},
    '6' : {'code':'LI','name':'Litoral'},
    '7' : {'code':'WN','name':'Wele-Nzas'}
  },
  'ER':{
    '1' : {'code':'MA','name':'Maekel'},
    '2' : {'code':'KE','name':'Anseba'},
    '3' : {'code':'DK','name':'Debub-Keih-Bah'},
    '4' : {'code':'SK','name':'Semien-Keih-Ba'},
    '5' : {'code':'DE','name':'Debub'},
    '6' : {'code':'BR','name':'Gash-Barka'}
  },
  'EE':{
    '1' : {'code':'HA','name':'Harju (Harjumaa)'},
    '2' : {'code':'HI','name':'Hiiu (Hiiumaa)'},
    '3' : {'code':'IV','name':'Viru Oriental (Ida-Virumaa)'},
    '4' : {'code':'JA','name':'Järva (Jarvamaa)'},
    '5' : {'code':'JO','name':'Jõgeva (Jõgevamaa)'},
    '6' : {'code':'LV','name':'Viru Occidental (Lääne-Virumaa)'},
    '7' : {'code':'LA','name':'Ouest (Läänemaa)'},
    '8' : {'code':'PA','name':'Pärnu (Pärnumaa)'},
    '9' : {'code':'PO','name':'Põlva (Põlvamaa)'},
    '10' : {'code':'RA','name':'Rapla (Paplamaa)'},
    '11' : {'code':'SA','name':'Saare (Saaremaa)'},
    '12' : {'code':'TA','name':'Tartu (Tartumaa)'},
    '13' : {'code':'VA','name':'Valga (Valgamaa)'},
    '14' : {'code':'VI','name':'Viljandi (Viljandimaa)'},
    '15' : {'code':'VO','name':'Võru (Võrumaa)'}
  },
  'ET':{
    '1' : {'code':'AF','name':'Afar'},
  ...
  'FJ':{
    '1' : {'code':'C','name':'Région centrale'},
    '2' : {'code':'E','name':'Région orientale'},
    '3' : {'code':'N','name':'Région septentrionale'},
    '4' : {'code':'R','name':'Rotuma'},
    '5' : {'code':'W','name':'Région occidentale'}
  },
  'FI':{
    '1' : {'code':'AL','name':'Åland (Ahvenanmaan lääni)'},
    '2' : {'code':'ES','name':'Finlande méridionale (Etelä-Suomen lääni)'},
    '3' : {'code':'IS','name':'Finlande orientale (Itä-Suomen lääni)'},
    '4' : {'code':'LS','name':'Finlande occidentale (Länsi-Suomen lääni)'},
    '5' : {'code':'LA','name':'Laponie (Lapin lääni)'},
    '6' : {'code':'OU','name':'Province d\'Oulu (Oulun lääni)'}
  },
  'FR':{
    ...
    '6' : {'code':'CE','name':'Centre-Val de Loire'},
    ...
    '16' : {'code':'PA','name':'Paris / Île-de-France'},
    '17' : {'code':'PI','name':'Picardie'},
    '18' : {'code':'PO','name':'Poitou-Charentes'},
    '19' : {'code':'PR','name':'Provence'},
    '20' : {'code':'RH','name':'Rhône-Alpes'},
    '21' : {'code':'RI','name':'Riviera'},
    '22' : {'code':'WE','name':'Pays-de-la-Loire'}
  },
  'FX':{
    '1' : {'code':'Et','name':'Étranger'},
    '2' : {'code':'01','name':'Ain'},
    ...
    '37' : {'code':'35','name':'Île-et-Vilaine'},
    '38' : {'code':'36','name':'Indre'},
    '39' : {'code':'37','name':'Indre-et-Loire'},
    '40' : {'code':'38','name':'Isère'},
    ...
    '66' : {'code':'64','name':'Pyrénées-Atlantiques'},
    '67' : {'code':'65','name':'Hautes-Pyrénées'},
    '68' : {'code':'66','name':'Pyrénées-Orientales'},
    ...
    '95' : {'code':'93','name':'Seine-Saint-Denis'},
  ...
  'GF':{
    ...
    '22' : {'code':'REM','name':'Rémire-Montjoly'}
  },
  'PF':{
    '1' : {'code':'M','name':'Archipel des Marquises'},
    '2' : {'code':'T','name':'Archipel des Tuamotu'},
    '3' : {'code':'I','name':'Archipel des Australes'},
    '4' : {'code':'V','name':'Îles du Vent'},
    '5' : {'code':'S','name':'Îles Sous-le-Vent'}
  },
  'TF':{
    '1' : {'code':'C','name':'Îles Crozet'},
    '2' : {'code':'K','name':'Îles Kerguelen'},
    '3' : {'code':'A','name':'Île d\'Amsterdam'},
    '4' : {'code':'P','name':'Île de Saint-Paul'},
    '5' : {'code':'D','name':'Terre Adélie'}
  },
  'GA':{
    '1' : {'code':'ES','name':'Estuaire'},
    '2' : {'code':'HO','name':'Haut-Ogooué'},
    '3' : {'code':'MO','name':'Moyen-Ogooué'},
    '4' : {'code':'NG','name':'Ngounié'},
    '5' : {'code':'NY','name':'Nyanga'},
    '6' : {'code':'OI','name':'Ogooué-Ivindo'},
    '7' : {'code':'OL','name':'Ogooué-Lolo'},
    '8' : {'code':'OM','name':'Ogooué-Maritime'},
  ...
  'GM':{
    ...
    '13' : {'code':'WE','name':'West Coast'}
  },
  'GE':{
    '1' : {'code':'AB','name':'Abkhazie'},
    '2' : {'code':'AJ','name':'Adjarie'},
    '3' : {'code':'GU','name':'Gourie'},
    '4' : {'code':'IM','name':'Iméréthie'},
    '5' : {'code':'KA','name':'Kakhétie'},
    '6' : {'code':'KK','name':'Kvemo Kartli'},
    '7' : {'code':'MM','name':'Mtskheta-Mtianeti'},
    '8' : {'code':'RL','name':'Racha-Lechkhumi et Kvemo Svaneti'},
    '9' : {'code':'SJ','name':'Samtskhe-Djavakheti'},
    '10' : {'code':'SK','name':'Shida Kartli'},
    '11' : {'code':'SZ','name':'Samegrelo-Zemo Svaneti'},
    '12' : {'code':'TB','name':'Tbilissi'}
  },
  'DE':{
    '1' : {'code':'BAW','name':'Bade-Wurtemberg'},
    '2' : {'code':'BAY','name':'Bavière'},
    '3' : {'code':'BER','name':'Berlin'},
    '4' : {'code':'BRG','name':'Brandebourg'},
    '5' : {'code':'BRE','name':'Brême'},
    '6' : {'code':'HAM','name':'Hamburg'},
    '7' : {'code':'HES','name':'Hesse'},
    '8' : {'code':'MEC','name':'Mecklembourg-Poméranie-Occidentale'},
    '9' : {'code':'NDS','name':'Basse-Saxe'},
    '10' : {'code':'NRW','name':'Rhénanie-du-Nord-Westphalie'},
    '11' : {'code':'RHE','name':'Rhénanie-Palatinat'},
    '12' : {'code':'SAR','name':'Sarre'},
    '13' : {'code':'SAS','name':'Saxe'},
    '14' : {'code':'SAC','name':'Saxe-Anhalt'},
    '15' : {'code':'SCN','name':'Schleswig-Holstein'},
    '16' : {'code':'THE','name':'Thuringe'}
  },
  'GH':{
    '1' : {'code':'AS','name':'Achanti'},
    '2' : {'code':'BA','name':'Brong-Ahafo'},
    '3' : {'code':'CE','name':'Centre'},
    '4' : {'code':'EA','name':'Est'},
    '5' : {'code':'GA','name':'Accra'},
    '6' : {'code':'NO','name':'Nord'},
    '7' : {'code':'UE','name':'Nord-Est'},
    '8' : {'code':'UW','name':'Nord-Ouest'},
    '9' : {'code':'VO','name':'Volta'},
    '10' : {'code':'WE','name':'Ouest'}
  },
  'GI':{
    ...
    '8' : {'code':'OTH','name':'Autre'}
  },
  'GR':{
    '1' : {'code':'AT','name':'Attique'},
    '2' : {'code':'CN','name':'Grèce-Centrale'},
    '3' : {'code':'CM','name':'Macédonie-Centrale'},
    '4' : {'code':'CR','name':'Crète'},
    '5' : {'code':'EM','name':'Macédonie-Orientale-et-Thrace'},
    '6' : {'code':'EP','name':'Épire'},
    '7' : {'code':'II','name':'Îles Ioniennes'},
    '8' : {'code':'NA','name':'Égée-Septentrionale'},
    '9' : {'code':'PP','name':'Péloponnèse'},
    '10' : {'code':'SA','name':'Égée-Méridionale'},
    '11' : {'code':'TH','name':'Thessalie'},
    '12' : {'code':'WG','name':'Grèce-Orientale'},
    '13' : {'code':'WM','name':'Macédoine-Occidentale'}
  },
  'GL':{
  ...
  'GP':{
    '1' : {'code':'ARR','name':'Arrondissements de la Guadeloupe'},
    '2' : {'code':'CAN','name':'Cantons de la Guadeloupe'},
    '3' : {'code':'COM','name':'Communes de la Guadeloupe'}
  },
  'GU':{
  ...
  'GT':{
    ...
    '5' : {'code':'PE','name':'Petén'},
    '6' : {'code':'PR','name':'El Progreso'},
    '7' : {'code':'QC','name':'Quiché'},
    ...
    '16' : {'code':'ST','name':'Sacatepéquez'},
    '17' : {'code':'SM','name':'San Marcos'},
    '18' : {'code':'SR','name':'Santa Rosa'},
    '19' : {'code':'SO','name':'Sololá'},
    '20' : {'code':'SU','name':'Suchitepéquez'},
    '21' : {'code':'TO','name':'Totonicapán'},
  ...
  'GW':{
    '1' : {'code':'BF','name':'Bafatá'},
    '2' : {'code':'BB','name':'Biombo'},
    '3' : {'code':'BS','name':'Bissau'},
    '4' : {'code':'BL','name':'Bolama'},
    '5' : {'code':'CA','name':'Cacheu'},
    '6' : {'code':'GA','name':'Gabu'},
    '7' : {'code':'OI','name':'Oio'},
    '8' : {'code':'QU','name':'Quinara'},
    '9' : {'code':'TO','name':'Tombali'}
  },
  'GY':{
  ...
  'HN':{
    '1' : {'code':'AT','name':'Atlántida'},
    '2' : {'code':'CH','name':'Choluteca'},
    '3' : {'code':'CL','name':'Colón'},
    '4' : {'code':'CM','name':'Comayagua'},
    '5' : {'code':'CP','name':'Copán'},
    '6' : {'code':'CR','name':'Cortés'},
    '7' : {'code':'PA','name':'El Paraíso'},
    '8' : {'code':'FM','name':'Francisco Morazán'},
    '9' : {'code':'GD','name':'Gracias a Dios'},
    '10' : {'code':'IN','name':'Intibucá'},
    '11' : {'code':'IB','name':'Islas de la Bahía'},
    '12' : {'code':'PZ','name':'La Paz'},
    '13' : {'code':'LE','name':'Lempira'},
    '14' : {'code':'OC','name':'Ocotepeque'},
    '15' : {'code':'OL','name':'Olancho'},
    '16' : {'code':'SB','name':'Santa Bárbara'},
    '17' : {'code':'VA','name':'Valle'},
    '18' : {'code':'YO','name':'Yoro'}
  },
  'HK':{
    '1' : {'code':'HCW','name':'Central and Western (Île de Hong Kong)'},
    '2' : {'code':'HEA','name':'Eastern (Île de Hong Kong)'},
    '3' : {'code':'HSO','name':'Southern (Île de Hong Kong)'},
    '4' : {'code':'HWC','name':'Wan Chai (Île de Hong Kong)'},
    ...
    '10' : {'code':'NIS','name':'Islands (Nouveaux Territoires)'},
    '11' : {'code':'NKT','name':'Kwai Tsing (Nouveaux Territoires)'},
    '12' : {'code':'NNO','name':'North (Nouveaux Territoires)'},
    '13' : {'code':'NSK','name':'Sai Kung (Nouveaux Territoires)'},
    '14' : {'code':'NST','name':'Sha Tin (Nouveaux Territoires)'},
    '15' : {'code':'NTP','name':'Tai Po (Nouveaux Territoires)'},
    '16' : {'code':'NTW','name':'Tsuen Wan (Nouveaux Territoires)'},
    '17' : {'code':'NTM','name':'Tuen Mun (Nouveaux Territoires)'},
    '18' : {'code':'NYL','name':'Yuen Long (Nouveaux Territoires)'}
  },
  'HU':{
    '1' : {'code':'BK','name':'Bács-Kiskun'},
    '2' : {'code':'BA','name':'Baranya'},
    '3' : {'code':'BE','name':'Békés'},
    '4' : {'code':'BS','name':'Békéscsaba'},
    '5' : {'code':'BZ','name':'Borsod-Abaúj-Zemplén'},
    '6' : {'code':'BU','name':'Budapest'},
    '7' : {'code':'CS','name':'Csongrád'},
    '8' : {'code':'DE','name':'Debrecen'},
    '9' : {'code':'DU','name':'Dunaújváros'},
    '10' : {'code':'EG','name':'Eger'},
    '11' : {'code':'FE','name':'Fejér'},
    '12' : {'code':'GY','name':'Györ'},
    '13' : {'code':'GM','name':'Györ-Moson-Sopron'},
    '14' : {'code':'HB','name':'Hajdú-Bihar'},
    '15' : {'code':'HE','name':'Heves'},
    '16' : {'code':'HO','name':'Hódmezõvásárhely'},
    '17' : {'code':'JN','name':'Jász-Nagykun-Szolnok'},
    '18' : {'code':'KA','name':'Kaposvár'},
    '19' : {'code':'KE','name':'Kecskemét'},
    '20' : {'code':'KO','name':'Komárom-Esztergom'},
    '21' : {'code':'MI','name':'Miskolc'},
    '22' : {'code':'NA','name':'Nagykanizsa'},
    '23' : {'code':'NO','name':'Nógrad'},
    '24' : {'code':'NY','name':'Nyiregyháza'},
    '25' : {'code':'PE','name':'Pécs'},
    '26' : {'code':'PS','name':'Pest'},
    '27' : {'code':'SO','name':'Somogy'},
    '28' : {'code':'SP','name':'Sopron'},
    '29' : {'code':'SS','name':'Szabolcs-Szatmár-Bereg'},
    '30' : {'code':'SZ','name':'Szeged'},
    '31' : {'code':'SE','name':'Székesféhérvár'},
    '32' : {'code':'SL','name':'Szolnok'},
    '33' : {'code':'SM','name':'Szombathely'},
    '34' : {'code':'TA','name':'Tatabánya'},
    '35' : {'code':'TO','name':'Tolna'},
    '36' : {'code':'VA','name':'Vas'},
    '37' : {'code':'VE','name':'Veszprém'},
    '38' : {'code':'ZA','name':'Zala'},
    '39' : {'code':'ZZ','name':'Zalaegerszeg'}
  },
  'IS':{
    '1' : {'code':'AL','name':'Austurland'},
    '2' : {'code':'HF','name':'Höfuðborgarsvæði'},
    '3' : {'code':'NE','name':'Norðurland eystra'},
    '4' : {'code':'NV','name':'Norðurland vestra'},
    '5' : {'code':'SL','name':'Suðurland'},
    '6' : {'code':'SN','name':'Suðurnes'},
    '7' : {'code':'VF','name':'Vestfirðir'},
    '8' : {'code':'VL','name':'Vesturland'}
  },
  'IN':{
    '1' : {'code':'AN','name':'Îles Andaman-et-Nicobar'},
    ...
    '25' : {'code':'PO','name':'Pondichéry'},
    '26' : {'code':'PU','name':'Penjab'},
    ...
    '32' : {'code':'WB','name':'Bengale-Occidental'}
  },
  'ID':{
    '1' : {'code':'DA','name':'Daista Aceh'},
    '2' : {'code':'SU','name':'Sumatra du Nord'},
    '3' : {'code':'SB','name':'Sumatra occidental'},
    '4' : {'code':'SI','name':'Riau'},
    '5' : {'code':'JA','name':'Jambi'},
    '6' : {'code':'SS','name':'Sumatra du Sud'},
    '7' : {'code':'BE','name':'Bengkulu'},
    '8' : {'code':'LA','name':'Lampung'},
    '9' : {'code':'JK','name':'Jakarta'},
    '10' : {'code':'JB','name':'Java occidental'},
    '11' : {'code':'JT','name':'Java central'},
    '12' : {'code':'DY','name':'Daista Yogyakarta'},
    '13' : {'code':'JT','name':'Java oriental'},
    '14' : {'code':'KB','name':'Kalimantan occidental'},
    '15' : {'code':'KT','name':'Kalimantan central'},
    '16' : {'code':'KI','name':'Kalimantan oriental'},
    '17' : {'code':'KS','name':'Kalimantan du Sud'},
    '18' : {'code':'BA','name':'Bali'},
    '19' : {'code':'NB','name':'Petites Îles de la Sonde occidentales'},
    '20' : {'code':'NT','name':'Petites Îles de la Sonde orientales'},
    '21' : {'code':'SN','name':'Sulawesi occidental'},
    '22' : {'code':'ST','name':'Sulawesi central'},
    '23' : {'code':'SA','name':'Sulawesi du Nord'},
    '24' : {'code':'SG','name':'Sulawesi du Sud-Est'},
    '25' : {'code':'MA','name':'Moluques'},
    '26' : {'code':'MU','name':'Moluques du Nord'},
    '27' : {'code':'IJ','name':'Irian Jaya oriental'},
    '28' : {'code':'IT','name':'Irian Jaya central'},
    '29' : {'code':'IB','name':'Irian Jawa occidental'},
    '30' : {'code':'BT','name':'Banten'},
    '31' : {'code':'BB','name':'Îles Bangka-Belitung'},
  ...
  'IR':{
    ...
    '4' : {'code':'EAZ','name':'Azarba¨djan Oriental'},
    '5' : {'code':'EFH','name':'Isfahan'},
    '6' : {'code':'FAR','name':'Fars'},
    '7' : {'code':'GIL','name':'Gilan'},
    '8' : {'code':'GLS','name':'Golestan'},
    '9' : {'code':'HMD','name':'Hamedan'},
    '10' : {'code':'HRM','name':'Hormozgan'},
    '11' : {'code':'ILM','name':'Ilam'},
    '12' : {'code':'KBA','name':'Kohkiluyeh et Buyer Ahmad'},
    '13' : {'code':'KRB','name':'Kerman'},
    '14' : {'code':'KRD','name':'Kurdistan iranien'},
    ...
    '20' : {'code':'NKH','name':'Khorasan-e-shomali'},
    '21' : {'code':'QAZ','name':'Qazvin'},
    '22' : {'code':'QOM','name':'Qom'},
    '23' : {'code':'RKH','name':'Khorasan-e-razavi'},
    '24' : {'code':'SBL','name':'Sistan-o-Balouchestan'},
    '25' : {'code':'SKH','name':'Khorasan-e-janubi'},
    '26' : {'code':'SMN','name':'Semnan'},
    '27' : {'code':'TEH','name':'Téhéran'},
    '28' : {'code':'WEZ','name':'Azarbaïdjan Occidental'},
    '29' : {'code':'YZD','name':'Yazd'},
    '30' : {'code':'ZAN','name':'Zanjan'}
  },
  'IQ':{
    '1' : {'code':'AB','name':'Al-Anbâr'},
    '2' : {'code':'AL','name':'Arbil'},
    '3' : {'code':'BA','name':'Al-Basra'},
    '4' : {'code':'BB','name':'Babil'},
    '5' : {'code':'BD','name':'Bagdad'},
    '6' : {'code':'DH','name':'Dahuk'},
    '7' : {'code':'DQ','name':'Dhi Qar'},
    '8' : {'code':'DY','name':'Diyala'},
    '9' : {'code':'KB','name':'Karbala'},
    '10' : {'code':'MU','name':'Al-Muthanna'},
    '11' : {'code':'MY','name':'Maysan'},
    '12' : {'code':'NJ','name':'An-Najaf'},
    '13' : {'code':'NN','name':'Ninawa'},
    '14' : {'code':'QA','name':'Al-Qadisiyya'},
    '15' : {'code':'SD','name':'Salah ad-Din'},
    '16' : {'code':'SL','name':'As-Sulaymaniya'},
    '17' : {'code':'TM','name':'Kirkuk'},
  ...
  'IL':{
    '1' : {'code':'BS','name':'Beer-Sheva'},
    '2' : {'code':'BH','name':'Bikat Hayarden'},
    '3' : {'code':'EA','name':'Eilat et Arava'},
    '4' : {'code':'GA','name':'Galilée'},
    '5' : {'code':'HA','name':'Haïfa'},
    '6' : {'code':'JM','name':'Monts de Judée'},
    '7' : {'code':'JE','name':'Jérusalem'},
    '8' : {'code':'NE','name':'Néguev'},
    '10' : {'code':'SE','name':'Samarie'},
    '11' : {'code':'SH','name':'Sharon'},
    '12' : {'code':'TA','name':'Tel Aviv (Gush Dan)'}
  },
  'IT':{
    '1' : {'code':'AG','name':'Agrigente'},
    '2' : {'code':'AL','name':'Alexandrie'},
    '3' : {'code':'AN','name':'Ancône'},
    '4' : {'code':'AO','name':'Aoste'},
    ...
    '11' : {'code':'BN','name':'Bénévent'},
    '12' : {'code':'BG','name':'Bergame'},
    '13' : {'code':'BI','name':'Biella'},
    '14' : {'code':'BO','name':'Bologne'},
    ...
    '21' : {'code':'CE','name':'Caserte'},
    '22' : {'code':'CT','name':'Catane'},
    '23' : {'code':'CZ','name':'Catanzaro'},
    '24' : {'code':'CH','name':'Chieti'},
    '25' : {'code':'CO','name':'Côme'},
    '26' : {'code':'CS','name':'Cosenza'},
    '27' : {'code':'CR','name':'Crémone'},
    '28' : {'code':'KR','name':'Crotone'},
    '29' : {'code':'CN','name':'Coni'},
    '30' : {'code':'EN','name':'Enna'},
    '31' : {'code':'FE','name':'Ferrare'},
    '32' : {'code':'FI','name':'Florence'},
    '33' : {'code':'FG','name':'Foggia'},
    '34' : {'code':'FO','name':'Forlì'},
    '35' : {'code':'FR','name':'Frosinone'},
    '36' : {'code':'GE','name':'Gênes'},
    '37' : {'code':'GO','name':'Gorizia'},
    '38' : {'code':'GR','name':'Grosseto'},
    '39' : {'code':'IM','name':'Imperia'},
    '40' : {'code':'IS','name':'Isernia'},
    '41' : {'code':'AQ','name':'L\'Aquila'},
    '42' : {'code':'SP','name':'La Spezia'},
    '43' : {'code':'LT','name':'Latina'},
    '44' : {'code':'LE','name':'Lecce'},
    '45' : {'code':'LC','name':'Lecco'},
    '46' : {'code':'LI','name':'Livourne'},
    '47' : {'code':'LO','name':'Lodi'},
    '48' : {'code':'LU','name':'Lucques'},
    '49' : {'code':'MC','name':'Macerata'},
    '50' : {'code':'MN','name':'Mantoue'},
    '51' : {'code':'MS','name':'Massa-Carrara'},
    '52' : {'code':'MT','name':'Matera'},
    '53' : {'code':'ME','name':'Messine'},
    '54' : {'code':'MI','name':'Milan'},
    '55' : {'code':'MO','name':'Modène'},
    '56' : {'code':'NA','name':'Naples'},
    '57' : {'code':'NO','name':'Novare'},
    '58' : {'code':'NU','name':'Nuoro'},
    '59' : {'code':'OR','name':'Oristano'},
    '60' : {'code':'PD','name':'Padoue'},
    '61' : {'code':'PA','name':'Palerme'},
    '62' : {'code':'PR','name':'Parme'},
    '63' : {'code':'PG','name':'Pérousse'},
    '64' : {'code':'PV','name':'Pavie'},
    '65' : {'code':'PU','name':'Pesaro Urbino'},
    '66' : {'code':'PE','name':'Pescara'},
    '67' : {'code':'PC','name':'Plaisance'},
    '68' : {'code':'PI','name':'Pise'},
    '69' : {'code':'PT','name':'Pistoia'},
    '70' : {'code':'PN','name':'Pordenone'},
    '71' : {'code':'PZ','name':'Potenza'},
    '72' : {'code':'PO','name':'Prato'},
    '73' : {'code':'RG','name':'Raguse'},
    '74' : {'code':'RA','name':'Ravenne'},
    '75' : {'code':'RC','name':'Reggio de Calabre'},
    '76' : {'code':'RE','name':'Reggio d\'Émilie'},
    '77' : {'code':'RI','name':'Rieti'},
    '78' : {'code':'RN','name':'Rimini'},
    '79' : {'code':'RM','name':'Rome'},
    '80' : {'code':'RO','name':'Rovigo'},
    '81' : {'code':'SA','name':'Salerne'},
    '82' : {'code':'SS','name':'Sassari'},
    '83' : {'code':'SV','name':'Savone'},
    '84' : {'code':'SI','name':'Sienne'},
    '85' : {'code':'SR','name':'Syracuse'},
    '86' : {'code':'SO','name':'Sondrio'},
    '87' : {'code':'TA','name':'Tarente'},
    '88' : {'code':'TE','name':'Teramo'},
    '89' : {'code':'TR','name':'Terni'},
    '90' : {'code':'TO','name':'Turin'},
    '91' : {'code':'TP','name':'Trapani'},
    '92' : {'code':'TN','name':'Trente'},
    '93' : {'code':'TV','name':'Trévise'},
    '94' : {'code':'TS','name':'Trieste'},
    '95' : {'code':'UD','name':'Udine'},
    '96' : {'code':'VA','name':'Varèse'},
    '97' : {'code':'VE','name':'Venise'},
    '98' : {'code':'VB','name':'Verbania'},
    '99' : {'code':'VC','name':'Verceil'},
    '100' : {'code':'VR','name':'Vérone'},
    '101' : {'code':'VV','name':'Vibo Valentia'},
    '102' : {'code':'VI','name':'Vicence'},
    '103' : {'code':'VT','name':'Viterbe'},
    ...
    '108' : {'code':'MB','name':'Monza et Brianza'},
    '109' : {'code':'FM','name':'Fermo'},
    '110' : {'code':'BT','name':'Barletta-Andria-Trani'}
  },
  'JM':{
    '1' : {'code':'CLA','name':'Clarendon'},
    '2' : {'code':'HAN','name':'Hanover'},
    '3' : {'code':'KIN','name':'Kingston'},
    '4' : {'code':'MAN','name':'Manchester'},
    '5' : {'code':'POR','name':'Portland'},
    '6' : {'code':'AND','name':'Saint Andrew'},
    '7' : {'code':'ANN','name':'Saint Ann'},
    '8' : {'code':'CAT','name':'Saint Catherine'},
    '9' : {'code':'ELI','name':'Saint Elizabeth'},
    '10' : {'code':'JAM','name':'Saint James'},
    '11' : {'code':'MAR','name':'Saint Mary'},
    '12' : {'code':'THO','name':'Saint Thomas'},
    '13' : {'code':'TRL','name':'Trelawny'},
    '14' : {'code':'WML','name':'Westmoreland'}
  },
  'JP':{
    ...
    '9' : {'code':'GI','name':'Gifu'},
    '10' : {'code':'GU','name':'Gunma'},
    '11' : {'code':'HI','name':'Hiroshima'},
    '12' : {'code':'HO','name':'Hokkaidō'},
    '13' : {'code':'HY','name':'Hyōgo'},
    ...
    '20' : {'code':'KO','name':'Kōchi'},
    '21' : {'code':'KU','name':'Kumamoto'},
    '22' : {'code':'KY','name':'Kyōto'},
    '23' : {'code':'MI','name':'Mie'},
  ...
  'KZ':{
    ...
    '2' : {'code':'AC','name':'Almaty (Ville)'},
    '3' : {'code':'AM','name':'Aqmola'},
    '4' : {'code':'AQ','name':'Aktioubé'},
    '5' : {'code':'AS','name':'Astana'},
    '6' : {'code':'AT','name':'Atyraou'},
    '7' : {'code':'BA','name':'Kazakhstan Occidental'},
    '8' : {'code':'BY','name':'Baïkonour'},
    '9' : {'code':'MA','name':'Manguistaou'},
    '10' : {'code':'ON','name':'Kazakhstan Méridional'},
    '11' : {'code':'PA','name':'Pavlodar'},
    '12' : {'code':'QA','name':'Karaganda'},
    '13' : {'code':'QO','name':'Koustanaï'},
    '14' : {'code':'QY','name':'Kyzylorda'},
    '15' : {'code':'SH','name':'Kazakhstan Oriental'},
    '16' : {'code':'SO','name':'Kazakhstan Septentrional'},
    '17' : {'code':'ZH','name':'Djamboul'}
  },
  'KE':{
    '1' : {'code':'CE','name':'Centre'},
    '2' : {'code':'CO','name':'Littoral'},
    '3' : {'code':'EA','name':'Est'},
    '4' : {'code':'NA','name':'Nairobi'},
    '5' : {'code':'NE','name':'Nord-Est'},
    '6' : {'code':'NY','name':'Nyanza'},
    '7' : {'code':'RV','name':'Rift Valley'},
    '8' : {'code':'WE','name':'Ouest'}
  },
  'KI':{
  ...
  'KP':{
    '1' : {'code':'CHA','name':'Jagang'},
    '2' : {'code':'HAB','name':'Hamgyong du Nord'},
    '3' : {'code':'HAN','name':'Hamgyong du Sud'},
    '4' : {'code':'HWB','name':'Hwanghae du Nord'},
    '5' : {'code':'HWN','name':'Hwanghae du Sud'},
    '6' : {'code':'KAN','name':'Kangwon'},
    '7' : {'code':'PYB','name':'Pyongan du Nord'},
    '8' : {'code':'PYN','name':'Pyongan du Sud'},
    '9' : {'code':'YAN','name':'Ryanggang'},
    '10' : {'code':'NAJ','name':'Rasŏn'},
    '11' : {'code':'PYO','name':'Pyongyang'}
  },
  'KR':{
    '1' : {'code':'CO','name':'Chungcheong du Nord'},
    '2' : {'code':'CH','name':'Chungcheong du Sud'},
    '3' : {'code':'CD','name':'Jeju'},
    '4' : {'code':'CB','name':'Jeolla du Nord'},
    '5' : {'code':'CN','name':'Jeolla du Sud'},
    '6' : {'code':'IG','name':'Incheon Gwang\'yeogsi'},
    '7' : {'code':'KA','name':'Gangwon'},
    '8' : {'code':'KG','name':'Gwangju Gwang\'yeogsi'},
    '9' : {'code':'KD','name':'Gyeonggi'},
    '10' : {'code':'KB','name':'Gyeongsang du Nord'},
    '11' : {'code':'KN','name':'Gyeongsang du Sud'},
    '12' : {'code':'PG','name':'Busan Gwang\'yeogsi'},
    '13' : {'code':'SO','name':'Seoul Teugbyeolsi'},
    '14' : {'code':'TA','name':'Taegu Gwang\'yeogsi'},
    '15' : {'code':'TG','name':'Taejon Gwang\'yeogsi'}
  },
  'KW':{
  ...
  'LT':{
    ...
    '3' : {'code':'KL','name':'Klaipéda'},
    '4' : {'code':'MA','name':'Marijampolé'},
    '5' : {'code':'PA','name':'Panevėžys'},
    '6' : {'code':'SI','name':'Šiauliai'},
    '7' : {'code':'TA','name':'Tauragė'},
    '8' : {'code':'TE','name':'Telšiai'},
  ...
  'MO':{
    '1' : {'code':'OLF','name':'Freguesia de Nossa Senhora de Fátima'},
    '2' : {'code':'ANT','name':'Freguesia de Santo António'},
    '3' : {'code':'LAZ','name':'Freguesia de São Lázaro'},
    '4' : {'code':'CAT','name':'Freguesia da Sé'},
    '5' : {'code':'LAW','name':'Freguesia de São Lourenço'}
  },
  'MK':{
    '1' : {'code':'AER','name':'Aerodrom'},
    '2' : {'code':'ARA','name':'Aratchinovo'},
    '3' : {'code':'BER','name':'Berovo'},
    '4' : {'code':'BIT','name':'Bitola'},
    '5' : {'code':'BOG','name':'Bogdantsi'},
    '6' : {'code':'BOG','name':'Bogovinje'},
    '7' : {'code':'BOS','name':'Bosilovo'},
    '8' : {'code':'BRV','name':'Brvenitsa'},
    '9' : {'code':'BUT','name':'Boutel'},
    '10' : {'code':'ČAI','name':'Tchaïr'},
    '11' : {'code':'ČAš','name':'Tchachka'},
    '12' : {'code':'CEN','name':'Tsentar'},
    '13' : {'code':'CEN','name':'Tsentar Joupa'},
    '14' : {'code':'Češ','name':'Tchechinovo-Oblechevo'},
    '15' : {'code':'ČUČ','name':'Tchoutcher Sandevo'},
    '16' : {'code':'DEB','name':'Debar'},
    '17' : {'code':'DEB','name':'Debartsa'},
    '18' : {'code':'DEL','name':'Deltchevo'},
    '19' : {'code':'DEM','name':'Demir Hisar'},
    '20' : {'code':'DEM','name':'Demir Kapija'},
    '21' : {'code':'DOL','name':'Dolneni'},
    '22' : {'code':'DRU','name':'Drougovo'},
    '23' : {'code':'GAZ','name':'Gazi Baba'},
    '24' : {'code':'GEV','name':'Gevgelija'},
    '25' : {'code':'GJO','name':'Guiortché Pétrov'},
    '26' : {'code':'GOS','name':'Gostivar'},
    '27' : {'code':'GRA','name':'Gradsko'},
    '28' : {'code':'ILI','name':'Ilinden'},
    '29' : {'code':'JEG','name':'Yégounovtsé'},
    '30' : {'code':'KAR','name':'Karbintsi'},
    '31' : {'code':'KAR','name':'Karpoch'},
    '32' : {'code':'KAV','name':'Kavadarci'},
    '33' : {'code':'KIČ','name':'Kitchevo'},
    '34' : {'code':'KIS','name':'Kisela Voda'},
    '35' : {'code':'KOč','name':'Kotchani'},
    '36' : {'code':'KON','name':'Kontché'},
    '37' : {'code':'KRA','name':'Kratovo'},
    '38' : {'code':'KRI','name':'Kriva Palanka'},
    '39' : {'code':'KRI','name':'Krivogachtani'},
    '40' : {'code':'KRU','name':'Krouchevo'},
    '41' : {'code':'KUM','name':'Koumanovo'},
    '42' : {'code':'LIP','name':'Lipkovo'},
    '43' : {'code':'LOZ','name':'Lozovo'},
    '44' : {'code':'MAK','name':'Makedonska Kamenitsa'},
    '45' : {'code':'MAK','name':'Makedonski Brod'},
    '46' : {'code':'MAV','name':'Mavrovo et Rostoucha'},
    '47' : {'code':'MOG','name':'Moguila'},
    '48' : {'code':'NEG','name':'Negotino'},
    '49' : {'code':'NOV','name':'Novatsi'},
    '50' : {'code':'NOV','name':'Novo Selo'},
    '51' : {'code':'OHR','name':'Ohrid'},
    '52' : {'code':'OSL','name':'Oslomeï'},
    '53' : {'code':'PEH','name':'Pehtchevo'},
    '54' : {'code':'PET','name':'Petrovets'},
    '55' : {'code':'PLA','name':'Plasnitsa'},
    '56' : {'code':'PRI','name':'Prilep'},
    '57' : {'code':'PRO','name':'Probichtip'},
    '58' : {'code':'RAD','name':'Radovich'},
    '59' : {'code':'RAN','name':'Rankovtsé'},
    '60' : {'code':'RES','name':'Resen'},
    '61' : {'code':'ROS','name':'Rosoman'},
    '62' : {'code':'SAR','name':'Saraï'},
    '63' : {'code':'SOP','name':'Sopichté'},
    '64' : {'code':'STA','name':'Star Doïran'},
    '65' : {'code':'STA','name':'Staro Nagoritchané'},
    '66' : {'code':'ŠTI','name':'Chtip'},
    '67' : {'code':'STR','name':'Strouga'},
    '68' : {'code':'STR','name':'Stroumitsa'},
    '69' : {'code':'STU','name':'Stoudenitchani'},
    '70' : {'code':'ŠUT','name':'Chouto Orizari'},
    '71' : {'code':'SVE','name':'Sveti Nikole'},
    '72' : {'code':'TEA','name':'Teartse'},
    '73' : {'code':'TET','name':'Tetovo'},
    '74' : {'code':'VAL','name':'Valandovo'},
    '75' : {'code':'VAS','name':'Vasilevo'},
    '76' : {'code':'VEL','name':'Vélès'},
    '77' : {'code':'VEV','name':'Vevtchani'},
    '78' : {'code':'VIN','name':'Vinitsa'},
    '79' : {'code':'VRA','name':'Vranechtitsa'},
    '80' : {'code':'VRA','name':'Vraptchichté'},
    '81' : {'code':'ZAJ','name':'Zaïas'},
    '82' : {'code':'ZEL','name':'Zelenikovo'},
    '83' : {'code':'ŽEL','name':'Jelino'},
    '84' : {'code':'ZRN','name':'Zrnovtsi'}
  },
  'MG':{
  ...
  'MV':{
    '1' : {'code':'AAD','name':'Ari Sud'},
    '2' : {'code':'AAU','name':'Ari Nord'},
    '3' : {'code':'ADD','name':'Addu'},
    '4' : {'code':'FAA','name':'Faadhippolhu'},
    '5' : {'code':'FEA','name':'Felidhue'},
    '6' : {'code':'FMU','name':'Mulaku'},
    '7' : {'code':'HAD','name':'Huvadhu Sud'},
    '8' : {'code':'HAU','name':'Huvadhu Nord'},
    '9' : {'code':'HDH','name':'Hadhdhunmathi'},
    '10' : {'code':'KLH','name':'Kolhumadulu'},
    '11' : {'code':'MAA','name':'Malé'},
    '12' : {'code':'MAD','name':'Maalhosmadulu Sud'},
    '13' : {'code':'MAU','name':'Maalhosmadulu Nord'},
    '14' : {'code':'MLD','name':'Miladummadulu Sud'},
    '15' : {'code':'MLU','name':'Miladummadulu Nord'},
    '16' : {'code':'MUA','name':'Mulaku'},
    '17' : {'code':'NAD','name':'Nilandhe Sud'},
    '18' : {'code':'NAU','name':'Nilandhe Nord'},
    '19' : {'code':'THD','name':'Thilandhunmathi Sud'},
    '20' : {'code':'THU','name':'Thilandhunmathi Nord'}
  },
  'ML':{
    '1' : {'code':'GA','name':'Gao'},
  ...
  'MT':{
    ...
    '5' : {'code':'BRZ','name':'Birżebbuġa'},
    '6' : {'code':'BOR','name':'Bormla'},
    '7' : {'code':'DIN','name':'Dingli'},
    '8' : {'code':'FGU','name':'Fgura'},
    '9' : {'code':'FLO','name':'Furjana'},
    '10' : {'code':'GDJ','name':'Gudja'},
    '11' : {'code':'GZR','name':'Gżira'},
    '12' : {'code':'GRG','name':'Għargħur'},
    '13' : {'code':'GXQ','name':'Għaxaq'},
    ...
    '25' : {'code':'MEL','name':'Mellieħa'},
    '26' : {'code':'MGR','name':'Mġarr'},
    ...
    '34' : {'code':'PIE','name':'Pietà'},
    '35' : {'code':'QOR','name':'Qormi'},
    '36' : {'code':'QRE','name':'Qrendi'},
    '37' : {'code':'RAB','name':'Rabat'},
    '38' : {'code':'SAF','name':'Safi'},
    '39' : {'code':'SGI','name':'San Ġiljan'},
    '40' : {'code':'SLU','name':'Santa Luċija'},
    '41' : {'code':'SPB','name':'San Pawl il-Baħar'},
    '42' : {'code':'SGW','name':'San Ġwann'},
    '43' : {'code':'SVE','name':'Santa Venera'},
    '44' : {'code':'SIG','name':'Siġġiewi'},
    '45' : {'code':'SLM','name':'Sliema'},
    '46' : {'code':'SWQ','name':'Swieqi'},
    '47' : {'code':'TXB','name':'Ta\' Xbiex'},
    '48' : {'code':'TRX','name':'Tarxien'},
    '49' : {'code':'VLT','name':'Valletta'},
    '50' : {'code':'XGJ','name':'Xgħajra'},
    '51' : {'code':'ZBR','name':'Żabbar'},
    '52' : {'code':'ZBG','name':'Żebbuġ'},
    '53' : {'code':'ZJT','name':'Żejtun'},
    '54' : {'code':'ZRQ','name':'Żurrieq'},
    '55' : {'code':'FNT','name':'Fontana'},
    '56' : {'code':'GHJ','name':'Għajnsielem'},
    '57' : {'code':'GHR','name':'Għarb'},
    '58' : {'code':'GHS','name':'Għasri'},
    '59' : {'code':'KRC','name':'Kerċem'},
    '60' : {'code':'MUN','name':'Munxar'},
    '61' : {'code':'NAD','name':'Nadur'},
    '62' : {'code':'QAL','name':'Qala'},
    '63' : {'code':'VIC','name':'Victoria'},
    '64' : {'code':'SLA','name':'San Lawrenz'},
    '65' : {'code':'SNT','name':'Ta\' Sannat'},
    '66' : {'code':'ZAG','name':'Xagħra'},
    '67' : {'code':'XEW','name':'Xewkija'},
    '68' : {'code':'ZEB','name':'Żebbuġ'}
  },
  'MH':{
  ...
  'MX':{
    ...
    '2' : {'code':'BCN','name':'Basse-Californie'},
    '3' : {'code':'BCS','name':'Basse-Californie-du-Sud'},
    ...
    '9' : {'code':'DIF','name':'District fédéral'},
    ...
    '16' : {'code':'MIC','name':'Michoacán de Ocampo'},
    '17' : {'code':'MOR','name':'Morelos'},
    '18' : {'code':'NAY','name':'Nayarit'},
    '19' : {'code':'NLE','name':'Nuevo León'},
    '20' : {'code':'OAX','name':'Oaxaca'},
    '21' : {'code':'PUE','name':'Puebla'},
    '22' : {'code':'QUE','name':'Querétaro de Arteaga'},
    '23' : {'code':'ROO','name':'Quintana Roo'},
    '24' : {'code':'SLP','name':'San Luis Potosíi'},
  ...
  'MN':{
    '1' : {'code':'1','name':'Oulan-Bator'},
    '2' : {'code':'035','name':'Orhon'},
    '3' : {'code':'037','name':'Darhan-Uul'},
    '4' : {'code':'039','name':'Hèntij'},
    '5' : {'code':'041','name':'Hövsgöl'},
    '6' : {'code':'043','name':'Hovd'},
    '7' : {'code':'046','name':'Uvs'},
    '8' : {'code':'047','name':'Töv'},
    '9' : {'code':'049','name':'Sèlèngè'},
    '10' : {'code':'051','name':'Sühbaatar'},
    '11' : {'code':'053','name':'Ömnögovi'},
    '12' : {'code':'055','name':'Övör-Hangaj'},
    '13' : {'code':'057','name':'Dzavhan'},
    '14' : {'code':'059','name':'Dundgovi'},
    '15' : {'code':'061','name':'Dornod'},
    '16' : {'code':'063','name':'Dornogovi'},
    '17' : {'code':'064','name':'Govi-Sumber'},
    '18' : {'code':'065','name':'Govi-Altaj'},
    '19' : {'code':'067','name':'Bulgan'},
    '20' : {'code':'069','name':'Bayan-Hongor'},
    '21' : {'code':'071','name':'Bayan-Ölgij'},
  ...
  'MM':{
    ...
    '8' : {'code':'CH','name':'État Chin'},
    '9' : {'code':'KC','name':'État Kachin'},
    '10' : {'code':'KH','name':'État Kayah'},
    '11' : {'code':'KN','name':'État Karen'},
    '12' : {'code':'MN','name':'État Môn'},
    '13' : {'code':'RK','name':'État Rakhine'},
    '14' : {'code':'SH','name':'État Shan'}
  },
  'NA':{
  ...
  'NP':{
    ...
    '7' : {'code':'KO','name':'Koshi'},
    '8' : {'code':'LU','name':'Limbini'},
  ...
  'NL':{
    ...
    '3' : {'code':'FR','name':'Frise'},
    '4' : {'code':'GE','name':'Geldre'},
    '5' : {'code':'GR','name':'Groningue'},
    '6' : {'code':'LI','name':'Limbourg'},
    '7' : {'code':'NB','name':'Brabant-Septentrional'},
    '8' : {'code':'NH','name':'Hollande-Septentrionale'},
    '9' : {'code':'OV','name':'Overijssel'},
    '10' : {'code':'UT','name':'Utrecht'},
    '11' : {'code':'ZE','name':'Zéland'},
    '12' : {'code':'ZH','name':'Hollande-Méridionale'}
  },
  'AN':{
    '1' : {'code':'BON','name':'Bonaire'},
    '2' : {'code':'CUR','name':'Curaçao'},
    '3' : {'code':'SAB','name':'Saba'},
    '4' : {'code':'SEU','name':'Saint-Eustache'},
    '5' : {'code':'SMA','name':'Saint-Martin'}
  },
  'NC':{
    '1' : {'code':'L','name':'Îles Loyauté'},
    '2' : {'code':'N','name':'Nord'},
    '3' : {'code':'S','name':'Sud'}
  },
  'NZ':{
    ...
    '10' : {'code':'MCM','name':'Mont Cook-Mackenzie'},
  ...
  'NE':{
    ...
    '7' : {'code':'TL','name':'Tillabéri'},
    '8' : {'code':'ZD','name':'Zinder'}
  },
  'NG':{
    '1' : {'code':'AB','name':'Abia'},
    '2' : {'code':'CT','name':'Territoire de la capitale fédérale du Nigeria'},
  ...
  'NU':{
    ...
    '13' : {'code':'ALO','name':'Alofi Sud'},
    '14' : {'code':'ALO','name':'Alofi Nord'}
  },
  'NF':{
    '1' : {'code':'NOR','name':'Île Norfolk'}
  },
  'MP':{
  ...
  'OM':{
    '1' : {'code':'DA','name':'Ad-Dākhilīyah'},
    '2' : {'code':'BA','name':'Al Batinah'},
    '3' : {'code':'WU','name':'Al Wusta'},
    '4' : {'code':'SH','name':'Ach-Charqiya'},
    '5' : {'code':'ZA','name':'Adh-Dhahira'},
    '6' : {'code':'MA','name':'Mascate'},
    '7' : {'code':'MU','name':'Musandam'},
    '8' : {'code':'ZU','name':'Dhofar'}
  },
  'PK':{
    '1' : {'code':'B','name':'Baloutchistan'},
    '2' : {'code':'T','name':'Régions tribales féféralement administrées'},
    '3' : {'code':'I','name':'Territoire fédéral d\'Islamabad'},
    '4' : {'code':'N','name':'Khyber Pakhtunkhwa'},
    '5' : {'code':'P','name':'Pendjab'},
    '6' : {'code':'S','name':'Sind'}
  },
  'PW':{
  ...
  'PA':{
    ...
    '2' : {'code':'CH','name':'Chiriquí'},
    '3' : {'code':'CC','name':'Coclé'},
    '4' : {'code':'CL','name':'Colón'},
    '5' : {'code':'DA','name':'Darén'},
    '6' : {'code':'HE','name':'Herrera'},
    '7' : {'code':'LS','name':'Los Santos'},
    '8' : {'code':'PA','name':'Panamá'},
  ...
  'PY':{
    ...
    '2' : {'code':'AN','name':'Alto Paraná'},
    '3' : {'code':'AM','name':'Amambay'},
    '4' : {'code':'AS','name':'Asunción'},
    '5' : {'code':'BO','name':'Boquerón'},
    '6' : {'code':'CG','name':'Caaguazú'},
    '7' : {'code':'CZ','name':'Caazapá'},
    '8' : {'code':'CN','name':'Canindeyú'},
    '9' : {'code':'CE','name':'Central'},
    '10' : {'code':'CC','name':'Concepción'},
    '11' : {'code':'CD','name':'Cordillera'},
    '12' : {'code':'GU','name':'Guairá'},
    '13' : {'code':'IT','name':'Itapúa'},
    '14' : {'code':'MI','name':'Misiones'},
    '15' : {'code':'NE','name':'Ñeembucú'},
    '16' : {'code':'PA','name':'Paraguarí'},
  ...
  'PH':{
    ...
    '30' : {'code':'ESA','name':'Samar Oriental'},
    ...
    '53' : {'code':'NCT','name':'Cotabato'},
    '54' : {'code':'NSM','name':'Samar du Nord'},
    ...
    '68' : {'code':'SCO','name':'Cotabato du Sud'},
    '69' : {'code':'SLE','name':'Leyte du Sud'},
  ...
  'PN':{
    '1' : {'code':'PIT','name':'Île Pitcairn'}
  },
  'PL':{
    '1': {'code':'DO','name':'Basse-Silésie'},
    '2' : {'code':'KP','name':'Cujavie-Poméranie'},
    '3': {'code':'LL','name':'Lublin'},
    '4': {'code':'LU','name':'Lubusz'},
    '5': {'code':'LO','name':'Łódź'},
    '6': {'code':'ML','name':'Petite-Pologne'},
    '7' : {'code':'MZ','name':'Mazovie'},
    '8' : {'code':'OP','name':'Opole'},
    '9' : {'code':'PP','name':'Basses-Carpates'},
    '10' : {'code':'PL','name':'Podlachie'},
    '11' : {'code':'PM','name':'Poméranie'},
    '12': {'code':'SL','name':'Silésie'},
    '13': {'code':'SW','name':'Sainte-Croix'},
    '14': {'code':'WM','name':'Varmie-Mazurie'},
    '15' : {'code':'WP','name':'Grande-Pologne'},
    '16' : {'code':'ZA','name':'Poméranie occidentale'}
  },
  'PT':{
    ...
    '13' : {'code':'LI','name':'Lisbonne'},
    '14' : {'code':'ME','name':'Madère'},
  ...
  'QA':{
    ...
    '2' : {'code':'GW','name':'Al Ghuwariyah'},
    '3' : {'code':'JM','name':'Al Jumaliyah'},
    '4' : {'code':'KR','name':'Al Khawr'},
    '5' : {'code':'WK','name':'Al Wakrah'},
    '6' : {'code':'RN','name':'Al Rayyan'},
    '7' : {'code':'JB','name':'Jariyan al Batnah'},
    '8' : {'code':'MS','name':'Ash Shamal'},
    '9' : {'code':'UD','name':'Umm Saieed'},
    '10' : {'code':'UL','name':'Umm Salal'}
  },
  'RO':{
    '1' : {'code':'AB','name':'Alba'},
    '2' : {'code':'AR','name':'Arad'},
    '3' : {'code':'AG','name':'Argeș'},
    '4' : {'code':'BC','name':'Bacău'},
    '5' : {'code':'BH','name':'Bihor'},
    '6' : {'code':'BN','name':'Bistrița-Năsăud'},
    '7' : {'code':'BT','name':'Botoșani'},
    '8' : {'code':'BV','name':'Brașov'},
    '9' : {'code':'BR','name':'Brăila'},
    '10' : {'code':'B','name':'Bucurest'},
    '11' : {'code':'BZ','name':'Buzău'},
    '12' : {'code':'CS','name':'Caraș-Severin'},
    '13' : {'code':'CL','name':'Călărași'},
    '14' : {'code':'CJ','name':'Cluj'},
    '15' : {'code':'CT','name':'Constanța'},
    '16' : {'code':'CV','name':'Covasna'},
    '17' : {'code':'DB','name':'Dâmbovița'},
    '18' : {'code':'DJ','name':'Dolj'},
    '19' : {'code':'GL','name':'Galați'},
    '20' : {'code':'GR','name':'Giurgiu'},
    '21' : {'code':'GJ','name':'Gorj'},
    '22' : {'code':'HR','name':'Harghita'},
    '23' : {'code':'HD','name':'Hunedoara'},
    '24' : {'code':'IL','name':'Ialomița'},
    '25' : {'code':'IS','name':'Iaşi'},
    '26' : {'code':'IF','name':'Ilfov'},
    '27' : {'code':'MM','name':'Maramureș'},
    '28' : {'code':'MH','name':'Mehedinți'},
    '29' : {'code':'MS','name':'Mureș'},
    '30' : {'code':'NT','name':'Neamț'},
    '31' : {'code':'OT','name':'Olt'},
    '32' : {'code':'PH','name':'Prahova'},
    '33' : {'code':'SM','name':'Satu Mare'},
    '34' : {'code':'SJ','name':'Sălaj'},
    '35' : {'code':'SB','name':'Sibiu'},
    '36' : {'code':'SV','name':'Suceava'},
    '37' : {'code':'TR','name':'Teleorman'},
    '38' : {'code':'TM','name':'Timiș'},
    '39' : {'code':'TL','name':'Tulcea'},
    '40' : {'code':'VS','name':'Vaslui'},
    '41' : {'code':'VL','name':'Vâlcea'},
  ...
  'RU':{
    ...
    '83' : {'code':'VO','name':'Voronej'},
    '84' : {'code':'VY','name':'Viatka'},
    '85' : {'code':'YA','name':'Iakoutsk'},
    '86' : {'code':'YR','name':'Iaroslavl'},
    '87' : {'code':'YE','name':'Iekaterinbourg'},
    '88' : {'code':'YO','name':'Iochkar-Ola'}
  },
  'RW':{
  ...
  'KN':{
    ...
    '6' : {'code':'SJC','name':'Saint-John Capisterre'},
    '7' : {'code':'SJF','name':'Saint-John Figtree'},
    '8' : {'code':'SMC','name':'Saint-Mary Cayon'},
    '9' : {'code':'CAP','name':'Saint-Paul Capisterre'},
  ...
  'SM':{
    ...
    '8' : {'code':'SM','name':'Ville de Saint-Marin'},
    '9' : {'code':'SE','name':'Serravalle'}
  },
  'ST':{
    '1' : {'code':'S','name':'Sao Tomé'},
    '2' : {'code':'P','name':'Principe'}
  },
  'SA':{
    '1' : {'code':'BH','name':'Al Bahah'},
    '2' : {'code':'HS','name':'Al-Hudud ach-Chamaliya'},
    '3' : {'code':'JF','name':'Al Jawf'},
    '4' : {'code':'MD','name':'Médine'},
    '5' : {'code':'QS','name':'Al Qasim'},
    '6' : {'code':'RD','name':'Riyad'},
    '7' : {'code':'AQ','name':'Ach-Charqiya (de l\'Est)'},
    '8' : {'code':'AS','name':'\'Asir'},
    '9' : {'code':'HL','name':'Haïl'},
    '10' : {'code':'JZ','name':'Jizan'},
    '11' : {'code':'ML','name':'La Mecque'},
  ...
  'SC':{
    ...
    '13' : {'code':'GM','name':'Grand\' Anse (Mahé)'},
    '14' : {'code':'GP','name':'Grand\' Anse (Praslin)'},
    '15' : {'code':'DG','name':'La Digue'},
    '16' : {'code':'RA','name':'La Rivière Anglaise'},
  ...
  'SL':{
    '1' : {'code':'E','name':'de l\'Est'},
    '2' : {'code':'N','name':'du Nord'},
    '3' : {'code':'S','name':'du Sud'},
    '4' : {'code':'W','name':'de l\'Ouest'}
  },
  'SK':{
    '1' : {'code':'BA','name':'Banská Bystrica'},
    '2' : {'code':'BR','name':'Bratislava'},
    '3' : {'code':'KO','name':'Kosičky'},
    '4' : {'code':'NI','name':'Nitriansky'},
    '5' : {'code':'PR','name':'Prešov'},
    '6' : {'code':'TC','name':'Trenčín'},
    '7' : {'code':'TV','name':'Trnava'},
    '8' : {'code':'ZI','name':'Žilina'}
  },
  'SI':{
    '1' : {'code':'4','name':'Styrie'},
    '2' : {'code':'2A','name':'Gorenjska'},
    '3' : {'code':'5','name':'Prekmurje'},
    '4' : {'code':'3','name':'Koroška'},
    '5' : {'code':'2B','name':'Carniole-Intérieure'},
  ...
  'SB':{
    ...
    '8' : {'code':'RB','name':'Rennell et Bellona'},
    '9' : {'code':'TM','name':'Temotu'},
    '10' : {'code':'WE','name':'occidentale'}
  },
  'SO':{
  ...
  'ZA':{
    '1' : {'code':'EC','name':'Cap-Oriental'},
    '2' : {'code':'FS','name':'État-Libre'},
    '3' : {'code':'GT','name':'Gauteng'},
    '4' : {'code':'KN','name':'KwaZulu-Natal'},
    '5' : {'code':'LP','name':'Limpopo'},
    '6' : {'code':'MP','name':'Mpumalanga'},
    '7' : {'code':'NW','name':'Nord-Ouest'},
    '8' : {'code':'NC','name':'Cap-du-Nord'},
    '9' : {'code':'WC','name':'Cap-Occidental'}
  },
  'ES':{
    '1' : {'code':'CA','name':'La Corogne'},
    '2' : {'code':'AL','name':'Alava'},
    '3' : {'code':'AB','name':'Albacete'},
    '4' : {'code':'AC','name':'Alicante'},
    '5' : {'code':'AM','name':'Almería'},
    '6' : {'code':'AS','name':'Asturies'},
    '7' : {'code':'AV','name':'Ávila'},
    '8' : {'code':'BJ','name':'Badajoz'},
    '9' : {'code':'IB','name':'Baléares'},
    '10' : {'code':'BA','name':'Barcelone'},
    '11' : {'code':'BU','name':'Burgos'},
    '12' : {'code':'CC','name':'Cáceres'},
    '13' : {'code':'CZ','name':'Cadix'},
    '14' : {'code':'CT','name':'Cantabrie'},
    '15' : {'code':'CL','name':'Castellón'},
    '16' : {'code':'CE','name':'Ceuta'},
    '17' : {'code':'CR','name':'Ciudad Real'},
    '18' : {'code':'CD','name':'Cordoue'},
    '19' : {'code':'CU','name':'Cuenca'},
    '20' : {'code':'GI','name':'Gérone'},
    '21' : {'code':'GD','name':'Grenade'},
    '22' : {'code':'GJ','name':'Guadalajara'},
    '23' : {'code':'GP','name':'Guipuscoa'},
    ...
    '30' : {'code':'LL','name':'Lleida'},
    '31' : {'code':'LG','name':'Lugo'},
    '32' : {'code':'MD','name':'Madrid'},
    '33' : {'code':'MA','name':'Málaga'},
    '34' : {'code':'ML','name':'Melilla'},
    '35' : {'code':'MU','name':'Murcie'},
    '36' : {'code':'NV','name':'Navarre'},
    '37' : {'code':'OU','name':'Orense'},
    '38' : {'code':'PL','name':'Palencia'},
    '39' : {'code':'PO','name':'Pontevedra'},
    '40' : {'code':'SL','name':'Salamanque'},
    '41' : {'code':'SC','name':'Santa Cruz de Tenerife'},
    '42' : {'code':'SG','name':'Ségovie'},
    '43' : {'code':'SV','name':'Séville'},
    '44' : {'code':'SO','name':'Soria'},
    '45' : {'code':'TA','name':'Tarragone'},
    '46' : {'code':'TE','name':'Teruel'},
    '47' : {'code':'TO','name':'Tolède'},
    '48' : {'code':'VC','name':'Valence'},
    '49' : {'code':'VD','name':'Valladolid'},
    '50' : {'code':'VZ','name':'Biscaye'},
    '51' : {'code':'ZM','name':'Zamora'},
    '52' : {'code':'ZR','name':'Saragosse'}
  },
  'LK':{
    '1' : {'code':'CE','name':'du Centre'},
    '2' : {'code':'EA','name':'de l\'Est'},
    '3' : {'code':'NC','name':'du Centre-Nord'},
    '4' : {'code':'NO','name':'du Nord'},
    '5' : {'code':'NW','name':'du Nord-Ouest'},
    '6' : {'code':'SA','name':'Sabaragamuwa'},
    '7' : {'code':'SO','name':'du Sud'},
    '8' : {'code':'UV','name':'Uva'},
    '9' : {'code':'WE','name':'de l\'Ouest'}
  },
  'SH':{
    '1' : {'code':'A','name':'Ascension'},
    '2' : {'code':'S','name':'Saint-Hélène'},
  ...
  'SD':{
    '1' : {'code':'ANL','name':'Nil Supérieur'},
    '2' : {'code':'BAM','name':'Mer Rouge'},
    '3' : {'code':'BRT','name':'Lac Al-Assad'},
    '4' : {'code':'JZR','name':'Al Jazirah'},
    '5' : {'code':'KRT','name':'Khartoum'},
    '6' : {'code':'QDR','name':'Al Qadarif'},
    '7' : {'code':'WDH','name':'Unité'},
    '8' : {'code':'ANB','name':'Nil Blanc'},
    '9' : {'code':'ANZ','name':'Nil Bleu'},
    '10' : {'code':'ASH','name':'Ach Chamaliyah'},
    '11' : {'code':'BJA','name':'Bahr al Jabal'},
    '12' : {'code':'GIS','name':'Équatoria-Occidental'},
    '13' : {'code':'GBG','name':'Bahr el Ghazal occidental'},
    '14' : {'code':'GDA','name':'Darfour-Occidental'},
    '15' : {'code':'GKU','name':'Kordofan de l\'Ouest'},
    '16' : {'code':'JDA','name':'Darfour du Sud'},
    '17' : {'code':'JKU','name':'Kordofan du Sud'},
    '18' : {'code':'JQL','name':'Jonglei'},
    '19' : {'code':'KSL','name':'Kassala'},
    '20' : {'code':'NNL','name':'Nil'},
    '21' : {'code':'SBG','name':'Bahr el Ghazal du Nord'},
    '22' : {'code':'SDA','name':'Darfour du Nord'},
    '23' : {'code':'SKU','name':'Kordofan du Nord'},
    '24' : {'code':'SIS','name':'Équatoria-Oriental'},
    '25' : {'code':'SNR','name':'Sannar'},
  ...
  'SZ':{
    ...
    '4' : {'code':'S','name':'Shiselweni'}
  },
  'SE':{
    '1' : {'code':'K','name':'Blekinge'},
    '2' : {'code':'W','name':'Dalécarlie'},
    ...
    '11' : {'code':'M','name':'Scanie'},
    '12' : {'code':'AB','name':'Stockholm'},
    '13' : {'code':'D','name':'Sudermanie'},
    '14' : {'code':'C','name':'Upsal'},
    '15' : {'code':'S','name':'Värmland'},
    '16' : {'code':'AC','name':'Botnie-Occidentale'},
    '17' : {'code':'Y','name':'Norrland occidental'},
  ...
  'CH':{
    '1' : {'code':'AG','name':'Argovie'},
    '2' : {'code':'AR','name':'Appenzell Rhodes-Extérieures'},
    '3' : {'code':'AI','name':'Appenzell Rhodes-Intérieures'},
    '4' : {'code':'BS','name':'Bâle-Ville'},
    '5' : {'code':'BL','name':'Bâle-Campagne'},
    '6' : {'code':'BE','name':'Berne'},
    '7' : {'code':'FR','name':'Fribourg'},
    '8' : {'code':'GE','name':'Genève'},
    '9' : {'code':'GL','name':'Glarus'},
    '10' : {'code':'GR','name':'Grisons'},
    '11' : {'code':'JU','name':'Jura'},
    '12' : {'code':'LU','name':'Lucerne'},
    '13' : {'code':'NE','name':'Neuchâtel'},
    '14' : {'code':'NW','name':'Nidwald'},
    '15' : {'code':'OW','name':'Obwald'},
    '16' : {'code':'SG','name':'Saint-Gall'},
    '17' : {'code':'SH','name':'Schaffhouse'},
    '18' : {'code':'SZ','name':'Schwytz'},
    '19' : {'code':'SO','name':'Soleure'},
    '20' : {'code':'TG','name':'Thurgovie'},
    '21' : {'code':'TI','name':'Tessin'},
    '22' : {'code':'UR','name':'Uri'},
    '23' : {'code':'VS','name':'Valais'},
    '24' : {'code':'VD','name':'Vaud'},
    '25' : {'code':'ZG','name':'Zoug'},
    '26' : {'code':'ZH','name':'Zurich'}
  },
  'SY':{
    '1' : {'code':'HA','name':'Hassaké'},
    '2' : {'code':'LA','name':'Lattaquié'},
    '3' : {'code':'QU','name':'Kuneitra'},
    '4' : {'code':'RQ','name':'Racca'},
    '5' : {'code':'SU','name':'Soueïda'},
    '6' : {'code':'DA','name':'Dara'},
    '7' : {'code':'DZ','name':'Deir ez-Zor'},
    '8' : {'code':'DI','name':'Damas'},
    '9' : {'code':'HL','name':'Alep'},
    '10' : {'code':'HM','name':'Hama'},
    '11' : {'code':'HI','name':'Homs'},
    '12' : {'code':'ID','name':'Idleb'},
    '13' : {'code':'RD','name':'Rif Dimachq'},
    '14' : {'code':'TA','name':'Tartous'}
  },
  'TW':{
    '1' : {'code':'CH','name':'Changhua'},
    '2' : {'code':'CI','name':'Chiayi'},
    '3' : {'code':'HS','name':'Hsinchu'},
    '4' : {'code':'HL','name':'Hualien'},
    '5' : {'code':'IL','name':'Yilan'},
    '6' : {'code':'KH','name':'Comté de Kaohsiung'},
    '7' : {'code':'KM','name':'Jinmen'},
    '8' : {'code':'LC','name':'Lienchiang'},
    '9' : {'code':'ML','name':'Miaoli'},
    '10' : {'code':'NT','name':'Nantou'},
    '11' : {'code':'PH','name':'Pescadores'},
    '12' : {'code':'PT','name':'Ping-tung'},
    '13' : {'code':'TG','name':'Taichung'},
    '14' : {'code':'TA','name':'Tainan'},
    '15' : {'code':'TP','name':'Comté de Taipei'},
    '16' : {'code':'TT','name':'Taitung'},
    '17' : {'code':'TY','name':'Taoyuan'},
    '18' : {'code':'YL','name':'Yunlin'},
    '19' : {'code':'CC','name':'Chiayi'},
    '20' : {'code':'CL','name':'Keelung'},
    '21' : {'code':'HC','name':'Hsinchu'},
    '22' : {'code':'TH','name':'Taichung'},
    '23' : {'code':'TN','name':'Tainan'},
    '24' : {'code':'KC','name':'Kaohsiung'},
    '25' : {'code':'TC','name':'Taipei'}
  },
  'TJ':{
    '1' : {'code':'GB','name':'Haut-Badakhchan'},
    '2' : {'code':'KT','name':'Khatlon'},
    '3' : {'code':'SU','name':'Sughd'}
  },
  'TZ':{
    '1' : {'code':'AR','name':'Arusha'},
    '2' : {'code':'DS','name':'Dar es Salam'},
    '3' : {'code':'DO','name':'Dodoma'},
    '4' : {'code':'IR','name':'Iringa'},
    '5' : {'code':'KA','name':'Kagera'},
    '6' : {'code':'KI','name':'Kigoma'},
    '7' : {'code':'KJ','name':'Kilimandjaro'},
    ...
    '15' : {'code':'PN','name':'Pemba Nord'},
    '16' : {'code':'PS','name':'Pemba Sud'},
    ...
    '24' : {'code':'ZC','name':'Zanzibar Central/Sud'},
    '25' : {'code':'ZN','name':'Zanzibar Nord'},
    '26' : {'code':'ZU','name':'Ville de Zanzibar/Ouest'}
  },
  'TH':{
    ...
    '12' : {'code':'Chon Buri','name':'Chonburi'},
    '13' : {'code':'Chumphon','name':'Chumpon'},
    ...
    '39' : {'code':'Phangnga','name':'Phang Nga'},
    '40' : {'code':'Phatthalung','name':'Phattalung'},
    ...
    '55' : {'code':'Sakon Nakhon','name':'Sakhon Nakhon'},
    '56' : {'code':'Samut Prakan','name':'Samut Prakan'},
    '57' : {'code':'Samut Sakhon','name':'Samut Sakhon'},
    '58' : {'code':'Samut Songkhram','name':'Samut Songkhram'},
    '59' : {'code':'Sara Buri','name':'Saraburi'},
    '60' : {'code':'Satun','name':'Satun'},
    '61' : {'code':'Sing Buri','name':'Singburi'},
    '62' : {'code':'Sisaket','name':'Si Saket'},
    '63' : {'code':'Songkhla','name':'Songkhla'},
    '64' : {'code':'Sukhothai','name':'Sukhothaï'},
    '65' : {'code':'Suphan Buri','name':'Suphanburi'},
  ...
  'TT':{
    ...
    '3' : {'code':'MR','name':'Rio Claro-Mayaro'},
    ...
    '10' : {'code':'PS','name':'Port d\'Espagne'},
  ...
  'TN':{
    ...
    '5' : {'code':'GB','name':'Gabès'},
    '6' : {'code':'GF','name':'Gafsa'},
    '7' : {'code':'JE','name':'Jendouba'},
    '8' : {'code':'KR','name':'Kairouan'},
    '9' : {'code':'KS','name':'Kasserine'},
    '10' : {'code':'KB','name':'Kébili'},
    '11' : {'code':'KF','name':'Le Kef'},
    '12' : {'code':'MH','name':'Mahdia'},
    '13' : {'code':'MN','name':'La Manouba'},
    '14' : {'code':'ME','name':'Médenine'},
  ...
  'TM':{
    ...
    '3' : {'code':'D','name':'Daşoguz Welayaty'},
    '4' : {'code':'L','name':'Lebap Welayaty'},
    '5' : {'code':'M','name':'Mary Welayaty'}
  },
  'TC':{
    '1' : {'code':'AC','name':'Ambergris Cay'},
    ...
    '9' : {'code':'SC','name':'Caïque du Sud'},
    '10' : {'code':'EC','name':'Caïque de l\'Est'},
    '11' : {'code':'MC','name':'Caïque Centrale'},
    '12' : {'code':'NC','name':'Caïque du Nord'},
    '13' : {'code':'PR','name':'Providenciales'},
    '14' : {'code':'WC','name':'Caïque de l\'Ouest'}
  },
  'TV':{
  ...
  'UA':{
    ...
    '2' : {'code':'CH','name':'Tchernihiv'},
    '3' : {'code':'CV','name':'Tchernivtsi'},
    '4' : {'code':'CR','name':'Crimée'},
    '5' : {'code':'DN','name':'Dnipropetrovsk'},
    '6' : {'code':'DO','name':'Donetsk'},
    '7' : {'code':'IV','name':'Ivano-Frankivsk'},
    '8' : {'code':'KL','name':'Kharkiv Kherson'},
    '9' : {'code':'KM','name':'Khmelnytskyï'},
    '10' : {'code':'KR','name':'Kirovohrad'},
    '11' : {'code':'KV','name':'Kiev'},
    '12' : {'code':'KY','name':'Kyiv'},
    '13' : {'code':'LU','name':'Luhansk'},
    '14' : {'code':'LV','name':'Lviv'},
    '15' : {'code':'MY','name':'Mykolaïv'},
    '16' : {'code':'OD','name':'Odessa'},
    '17' : {'code':'PO','name':'Poltava'},
    '18' : {'code':'RI','name':'Rivne'},
    '19' : {'code':'SE','name':'Sébastopol'},
    '20' : {'code':'SU','name':'Soumy'},
    '21' : {'code':'TE','name':'Ternopil'},
    '22' : {'code':'VI','name':'Vinnytsya'},
    '23' : {'code':'VO','name':'Volyn'},
    '24' : {'code':'ZK','name':'Transcarpatie'},
    '25' : {'code':'ZA','name':'Zaporijia'},
    '26' : {'code':'ZH','name':'Jytomyr'}
  },
  'AE':{
    '1' : {'code':'AZ','name':'Abou Dabi'},
    '2' : {'code':'AJ','name':'Ajman'},
    '3' : {'code':'FU','name':'Fujaïrah'},
    '4' : {'code':'SH','name':'Charjah'},
    '5' : {'code':'DU','name':'Dubaï'},
    '6' : {'code':'RK','name':'Ras el Khaïmah'},
    '7' : {'code':'UQ','name':'Oumm al Qaïwaïn'}
  },
  'GB':{
    ...
    '32' : {'code':'ERYS','name':'Yorkshire de l\'Est'},
    '33' : {'code':'SXE','name':'Sussex de l\'Est'},
    '34' : {'code':'EDIN','name':'Édimbourg'},
    ...
    '41' : {'code':'LDN','name':'Grand Londres'},
    '42' : {'code':'MCH','name':'Grand Manchester'},
    ...
    '94' : {'code':'WMD','name':'Midlands de l\'Ouest'},
    '95' : {'code':'SXW','name':'Sussex de l\'Ouest'},
    '96' : {'code':'YSW','name':'Yorkshire de l\'Ouest'},
    '97' : {'code':'WIL','name':'Hébrides extérieures'},
  ...
  'US':{
    ...
    '3' : {'code':'AS','name':'Samoa américaines'},
    '4' : {'code':'AZ','name':'Arizona'},
    '5' : {'code':'AR','name':'Arkansas'},
    '6' : {'code':'AF','name':'Forces armées africaines'},
    '7' : {'code':'AA','name':'Forces armées américaines'},
    '8' : {'code':'AC','name':'Forces armées canadiennes'},
    '9' : {'code':'AE','name':'Forces armées européennes'},
    '10' : {'code':'AM','name':'Forces armées du Moyen-Orient'},
    '11' : {'code':'AP','name':'Forces armées du Pacifique'},
    '12' : {'code':'CA','name':'Californie'},
    '13' : {'code':'CO','name':'Colorado'},
    '14' : {'code':'CT','name':'Connecticut'},
    '15' : {'code':'DE','name':'Delaware'},
    '16' : {'code':'DC','name':'District de Columbia'},
    '17' : {'code':'FM','name':'États fédérés de Micronésie'},
    '18' : {'code':'FL','name':'Floride'},
    '19' : {'code':'GA','name':'Georgie'},
    '20' : {'code':'GU','name':'Guam'},
    '21' : {'code':'HI','name':'Hawaï'},
    ...
    '28' : {'code':'LA','name':'Louisiane'},
    '29' : {'code':'ME','name':'Maine'},
    '30' : {'code':'MH','name':'Îles Marshall'},
    ...
    '42' : {'code':'NM','name':'Nouveau-Mexique'},
    '43' : {'code':'NY','name':'New York'},
    '44' : {'code':'NC','name':'Caroline du Nord'},
    '45' : {'code':'ND','name':'Dakota du Nord'},
    '46' : {'code':'MP','name':'Îles Mariannes du Nord'},
    '47' : {'code':'OH','name':'Ohio'},
    '48' : {'code':'OK','name':'Oklahoma'},
    '49' : {'code':'OR','name':'Oregon'},
    '50' : {'code':'PW','name':'Palau'},
    '51' : {'code':'PA','name':'Pennsylvanie'},
    '52' : {'code':'PR','name':'Porto Rico'},
    '53' : {'code':'RI','name':'Rhode Island'},
    '54' : {'code':'SC','name':'Caroline du Sud'},
    '55' : {'code':'SD','name':'Dakota du Sud'},
    '56' : {'code':'TN','name':'Tennessee'},
    '57' : {'code':'TX','name':'Texas'},
    '58' : {'code':'UT','name':'Utah'},
    '59' : {'code':'VT','name':'Vermont'},
    '60' : {'code':'VI','name':'Îles Vierges'},
    '61' : {'code':'VA','name':'Virginie'},
    '62' : {'code':'WA','name':'Washington'},
    '63' : {'code':'WV','name':'Virginie-Occidentale'},
    '64' : {'code':'WI','name':'Wisconsin'},
    '65' : {'code':'WY','name':'Wyoming'}
  },
  'UM':{
    '1' : {'code':'BI','name':'Île Baker'},
    '2' : {'code':'HI','name':'Île Howland'},
    '3' : {'code':'JI','name':'Île Jarvis'},
    '4' : {'code':'JA','name':'Atoll Johnston'},
    '5' : {'code':'KR','name':'Récif Kingman'},
    '6' : {'code':'MA','name':'Îles Midway'},
    '7' : {'code':'NI','name':'Île de la Navasse'},
    '8' : {'code':'PA','name':'Atoll Palmyra'},
    '9' : {'code':'WI','name':'Atoll Wake'}
  },
  'UY':{
    ...
    '11' : {'code':'PA','name':'Paysandú'},
    '12' : {'code':'RN','name':'Río Negro'},
    '13' : {'code':'RV','name':'Rivera'},
    '14' : {'code':'RO','name':'Rocha'},
    '15' : {'code':'SL','name':'Salto'},
    '16' : {'code':'SJ','name':'San José'},
    '17' : {'code':'SO','name':'Soriano'},
    '18' : {'code':'TA','name':'Tacuarembó'},
    '19' : {'code':'TT','name':'Treinta y Tres'}
  },
  'UZ':{
    '1' : {'code':'AN','name':'Andijan'},
    '2' : {'code':'BU','name':'Boukhara'},
    '3' : {'code':'FA','name':'Ferghana'},
    '4' : {'code':'JI','name':'Djizak'},
    '5' : {'code':'NG','name':'Namangan'},
    '6' : {'code':'NW','name':'Navoï'},
    '7' : {'code':'QA','name':'Kachkadaria'},
    '8' : {'code':'QR','name':'Karakalpakistan'},
    '9' : {'code':'SA','name':'Samarcande'},
    '10' : {'code':'SI','name':'Sirdaryo'},
    '11' : {'code':'SU','name':'Sourkhan-Daria'},
    '12' : {'code':'TK','name':'Tachkent'},
    '13' : {'code':'TO','name':'Région de Tachkent'},
    '14' : {'code':'XO','name':'Khwarezm'}
  },
  'VU':{
    '1' : {'code':'MA','name':'Malampa'},
    '2' : {'code':'PE','name':'Pénama'},
    '3' : {'code':'SA','name':'Sanma'},
    '4' : {'code':'SH','name':'Shéfa'},
    '5' : {'code':'TA','name':'Taféa'},
    '6' : {'code':'TO','name':'Torba'}
  },
  'VE':{
    '1' : {'code':'AM','name':'Amazonas'},
    '2' : {'code':'AN','name':'Anzoátegui'},
    '3' : {'code':'AP','name':'Apure'},
    '4' : {'code':'AR','name':'Aragua'},
    '5' : {'code':'BA','name':'Barinas'},
    '6' : {'code':'BO','name':'Bolívar'},
    '7' : {'code':'CA','name':'Carabobo'},
    '8' : {'code':'CO','name':'Cojedes'},
    '9' : {'code':'DA','name':'Delta Amacuro'},
    '10' : {'code':'DF','name':'Dépendances fédérales'},
    '11' : {'code':'DI','name':'District fédéral'},
    '12' : {'code':'FA','name':'Falcón'},
    '13' : {'code':'GU','name':'Guárico'},
    '14' : {'code':'LA','name':'Lara'},
    '15' : {'code':'ME','name':'Mérida'},
  ...
  'VN':{
    ...
    '2' : {'code':'BG','name':'Bắc Giang'},
    '3' : {'code':'BK','name':'Bắc Kạn'},
    '4' : {'code':'BL','name':'Bạc Liêu'},
    '5' : {'code':'BC','name':'Bắc Ninh'},
    '6' : {'code':'BR','name':'Bà Rịa-Vũng Tàu'},
    '7' : {'code':'BN','name':'Bến Tre'},
    '8' : {'code':'BH','name':'Bình Định'},
    '9' : {'code':'BU','name':'Bình Dương'},
    ...
    '15' : {'code':'DL','name':'Đắk Lắk'},
    '16' : {'code':'DG','name':'Đắk Nông'},
    '17' : {'code':'DN','name':'Đà Nẵng'},
    '18' : {'code':'DB','name':'Điện Biên'},
    '19' : {'code':'DI','name':'Đồng Nai'},
    '20' : {'code':'DT','name':'Đồng Tháp'},
    '21' : {'code':'GL','name':'Gia Lai'},
    '22' : {'code':'HG','name':'Hà Giang'},
    '23' : {'code':'HD','name':'Hai Duong'},
    '24' : {'code':'HP','name':'Hải Phòng'},
    '25' : {'code':'HM','name':'Hà Nam'},
    '26' : {'code':'HI','name':'Hanoï'},
    '27' : {'code':'HT','name':'Hà Tây'},
    '28' : {'code':'HH','name':'Hà Tĩnh'},
    '29' : {'code':'HB','name':'Hòa Bình'},
    '30' : {'code':'HC','name':'Hô Chi Minh'},
    '31' : {'code':'HU','name':'Hậu Giang'},
    '32' : {'code':'HY','name':'Hưng Yên'}
  },
  'VI':{
    '1' : {'code':'C','name':'Sainte-Croix'},
  ...
  'YE':{
    ...
    '7' : {'code':'HD','name':'Hadramaout'},
    '8' : {'code':'HJ','name':'Hajjah'},
    '9' : {'code':'HU','name':'Al Hudaydah'},
    '10' : {'code':'IB','name':'Ibb'},
    '11' : {'code':'JA','name':'El-Giof'},
    '12' : {'code':'LA','name':'Lahij'},
    '13' : {'code':'MA','name':'Marib'},
    '14' : {'code':'MR','name':'Mahra'},
    '15' : {'code':'MW','name':'Al Mahwit'},
    '16' : {'code':'SD','name':'Sa\'dah'},
    '17' : {'code':'SN','name':'Sana'},
    '18' : {'code':'SH','name':'Shabwah'},
    '19' : {'code':'TA','name':'Ta\'izz'}
  },
  'YU':{
    '1' : {'code':'KOS','name':'Kosovo'},
    '2' : {'code':'MON','name':'Monténégro'},
    '3' : {'code':'SER','name':'Serbie'},
    '4' : {'code':'VOJ','name':'Voïvodine'}
  },
  'ZR':{
    ...
    '5' : {'code':'KE','name':'Kasaï-Oriental'},
    '6' : {'code':'KN','name':'Kinshasa'},
    '7' : {'code':'KW','name':'Kasaï-Occidental'},
  ...
  'ZM':{
    ...
    '3' : {'code':'EA','name':'Oriental'},
    '4' : {'code':'LP','name':'Lwapula'},
    '5' : {'code':'LK','name':'Lusaka'},
    '6' : {'code':'NO','name':'Septentrional'},
    '7' : {'code':'NW','name':'Nord-occidental'},
    '8' : {'code':'SO','name':'Méridional'},
    '9' : {'code':'WE','name':'Occidental'}
  },
  'ZW':{
    ...
    '5' : {'code':'ME','name':'Mashonaland oriental'},
    '6' : {'code':'MW','name':'Mashonaland occidental'},
    '7' : {'code':'MV','name':'Masvingo'},
    '8' : {'code':'MN','name':'Matabeleland septentrional'},
    '9' : {'code':'MS','name':'Matabeleland méridional'},
